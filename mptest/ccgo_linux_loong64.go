// Code generated for linux/loong64 by 'generator -DNDEBUG -DSQLITE_DISABLE_INTRINSIC -I /tmp/libsqlite3/sqlite-src-3530200 -ignore-unsupported-alignment -ignore-link-errors -o mptest/ccgo_linux_loong64.go /tmp/libsqlite3/sqlite-src-3530200/mptest/mptest.c -lsqlite3', DO NOT EDIT.
...
func unrecognizedArguments(tls *libc.TLS, argv0 uintptr, nArg int32, azArg uintptr) {
	...
	for {
		...
		libc.Xfprintf(tls, libc.Xstderr, __ccgo_ts+2332, libc.VaList(bp+8, **(**uintptr)(__ccgo_up(azArg + uintptr(i)*8))))
		goto _1
	_1:
		;
		i = i + 1
