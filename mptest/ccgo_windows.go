// Code generated for windows/amd64 by 'generator --cpp /usr/bin/x86_64-w64-mingw32-gcc --goarch amd64 --goos windows -DNDEBUG -DSQLITE_DISABLE_INTRINSIC -DSQLITE_ENABLE_DBPAGE_VTAB -DSQLITE_OMIT_SEH -DSQLITE_OS_WIN=1 -I /tmp/libsqlite3/sqlite-src-3530400 -build-lines \/\/go:build windows && (amd64 || arm64)\n\/\/ \x2bbuild windows\n\/\/ \x2bbuild amd64 arm64 -map gcc=x86_64-w64-mingw32-gcc -o mptest/ccgo_windows.go /tmp/libsqlite3/sqlite-src-3530400/mptest/mptest.c -lsqlite3', DO NOT EDIT.
...
func startClient(tls *libc.TLS, iClient int32) {
	...
	if libsqlite3.Xsqlite3_changes(tls, g.Fdb) != 0 {
		...
		(**(**STARTUPINFOA)(__ccgo_up(bp))).Fcb = uint32(104)
		...
		if rc != 0 {
			libc.XCloseHandle(tls, (**(**PROCESS_INFORMATION)(__ccgo_up(bp + 104))).FhThread)
			libc.XCloseHandle(tls, (**(**PROCESS_INFORMATION)(__ccgo_up(bp + 104))).FhProcess)
		} else {
...
func findEnd(tls *libc.TLS, z uintptr, pnLine uintptr) (r int32) {
	...
	_ = n
	n = 0
	for **(**int8)(__ccgo_up(z + uintptr(n))) != 0 && (libc.Xstrncmp(tls, z+uintptr(n), __ccgo_ts+913, uint64(5)) != 0 || !(libc.Xisspace(tls, int32(uint8(**(**int8)(__ccgo_up(z + uintptr(n+int32(5))))))) != 0)) {
...
func findEndif(tls *libc.TLS, z uintptr, stopAtElse int32, pnLine uintptr) (r int32) {
	...
	for **(**int8)(__ccgo_up(z + uintptr(n))) != 0 {
		...
		if libc.Xstrncmp(tls, z+uintptr(n), __ccgo_ts+919, uint64(7)) == 0 && libc.Xisspace(tls, int32(uint8(**(**int8)(__ccgo_up(z + uintptr(n+int32(7))))))) != 0 || stopAtElse != 0 && libc.Xstrncmp(tls, z+uintptr(n), __ccgo_ts+927, uint64(6)) == 0 && libc.Xisspace(tls, int32(uint8(**(**int8)(__ccgo_up(z + uintptr(n+int32(6))))))) != 0 {
			return n + len1
		}
		if libc.Xstrncmp(tls, z+uintptr(n), __ccgo_ts+934, uint64(4)) == 0 && libc.Xisspace(tls, int32(uint8(**(**int8)(__ccgo_up(z + uintptr(n+int32(4))))))) != 0 {
	...
	**(**int32)(__ccgo_up(bp + 16)) = int32(1)
	...
	for {
		...
		for {
			...
			v1 = j
			j = j + 1
			**(**int8)(__ccgo_up(bp + 1070 + uintptr(v1)*100)) = 0
			goto _3
		_3:
			;
			j = j + 1
					...
					if libc.Xstrcmp(tls, bp+40, __ccgo_ts+1244) == 0 && iClient > 0 {
						...
						if libc.Xstrcmp(tls, bp+40, __ccgo_ts+1251) == 0 {
							...
							if libc.Xstrcmp(tls, bp+40, __ccgo_ts+1257) == 0 {
								...
								if len1-jj-int32(1) != (**(**String)(__ccgo_up(bp + 24))).Fn || libc.Xstrncmp(tls, (**(**String)(__ccgo_up(bp + 24))).Fz, zAns, uint64(len1-jj-int32(1))) != 0 {
									errorMessage(tls, __ccgo_ts+1263, libc.VaList(bp+1280, prevLine, zFilename, len1-jj-int32(1), zAns, (**(**String)(__ccgo_up(bp + 24))).Fz))
								}
								g.FnTest = g.FnTest + 1
								stringReset(tls, bp+24)
							} else {
								...
								if libc.Xstrcmp(tls, bp+40, __ccgo_ts+1308) == 0 || libc.Xstrcmp(tls, bp+40, __ccgo_ts+1313) == 0 {
									...
									isGlob = libc.BoolInt32(int32((**(**[30]int8)(__ccgo_up(bp + 40)))[0]) == int32('g'))
									...
									if libc.BoolInt32(libsqlite3.Xsqlite3_strglob(tls, zCopy, (**(**String)(__ccgo_up(bp + 24))).Fz) == 0)^isGlob != 0 {
										errorMessage(tls, __ccgo_ts+1321, libc.VaList(bp+1280, prevLine, zFilename, zCopy, (**(**String)(__ccgo_up(bp + 24))).Fz))
									}
									...
									if libc.Xstrcmp(tls, bp+40, __ccgo_ts+1364) == 0 {
										logMessage(tls, __ccgo_ts+438, libc.VaList(bp+1280, (**(**String)(__ccgo_up(bp + 24))).Fz))
									} else {
										/*
										 **  --source FILENAME
										 **
