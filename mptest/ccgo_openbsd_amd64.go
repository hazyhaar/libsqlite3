// Code generated for openbsd/amd64 by 'generator -DNDEBUG -DSQLITE_DISABLE_INTRINSIC -I /tmp/libsqlite3/sqlite-src-3530300 -ignore-unsupported-alignment -ignore-link-errors -o mptest/ccgo_openbsd_amd64.go /tmp/libsqlite3/sqlite-src-3530300/mptest/mptest.c -lsqlite3', DO NOT EDIT.
				...
				if c == int32('[') {
					...
					if c == int32('#') {
						if v6 = int32(**(**int8)(__ccgo_up(z))) == int32('-') || int32(**(**int8)(__ccgo_up(z))) == int32('+'); v6 {
							v1 = libc.Int32FromUint8(libc.Uint8FromInt8(**(**int8)(__ccgo_up(z + 1))))
							if v1 == -int32(1) {
								v7 = 0
							} else {
								v7 = int32(**(**int8)(__ccgo_up(libc.X_ctype_ + libc.UintptrFromInt32(1) + uintptr(libc.Uint8FromInt32(v1))))) & int32(_CTYPE_N)
							}
							v3 = v7
							goto _19
						_19:
						...
						v1 = libc.Int32FromUint8(libc.Uint8FromInt8(**(**int8)(__ccgo_up(z))))
						if v1 == -int32(1) {
							v7 = 0
						} else {
							v7 = int32(**(**int8)(__ccgo_up(libc.X_ctype_ + libc.UintptrFromInt32(1) + uintptr(libc.Uint8FromInt32(v1))))) & int32(_CTYPE_N)
...
func clipLength(tls *libc.TLS, z uintptr) (r int32) {
	...
	for {
		if v5 = n > 0; v5 {
			v1 = libc.Int32FromUint8(libc.Uint8FromInt8(**(**int8)(__ccgo_up(z + uintptr(n-int32(1))))))
			if v1 == -int32(1) {
				v4 = 0
			} else {
...
func stringAppendTerm(tls *libc.TLS, p uintptr, z uintptr) {
	...
	i = 0
	for {
		if v6 = **(**int8)(__ccgo_up(z + uintptr(i))) != 0; v6 {
			v2 = libc.Int32FromUint8(libc.Uint8FromInt8(**(**int8)(__ccgo_up(z + uintptr(i)))))
			if v2 == -int32(1) {
				v5 = 0
			} else {
				v5 = int32(**(**int8)(__ccgo_up(libc.X_ctype_ + libc.UintptrFromInt32(1) + uintptr(libc.Uint8FromInt32(v2))))) & int32(_CTYPE_S)
			}
			v3 = v5
			goto _4
		_4:
...
_3:
	;
	if v2 != 0 || int32(**(**int8)(__ccgo_up(z))) == int32('/') && int32(**(**int8)(__ccgo_up(z + 1))) == int32('*') {
		inC = 0
...
func extractToken(tls *libc.TLS, zIn uintptr, nIn int32, zOut uintptr, nOut int32) (r int32) {
	...
	for {
		if v6 = i < nIn && i < nOut-int32(1); v6 {
			v2 = libc.Int32FromUint8(libc.Uint8FromInt8(**(**int8)(__ccgo_up(zIn + uintptr(i)))))
			if v2 == -int32(1) {
				v5 = 0
			} else {
				v5 = int32(**(**int8)(__ccgo_up(libc.X_ctype_ + libc.UintptrFromInt32(1) + uintptr(libc.Uint8FromInt32(v2))))) & int32(_CTYPE_S)
...
func findEnd(tls *libc.TLS, z uintptr, pnLine uintptr) (r int32) {
	...
	n = 0
	for {
		if v6 = **(**int8)(__ccgo_up(z + uintptr(n))) != 0; v6 {
			if v5 = libc.Xstrncmp(tls, z+uintptr(n), __ccgo_ts+909, uint64(5)) != 0; !v5 {
				v1 = libc.Int32FromUint8(libc.Uint8FromInt8(**(**int8)(__ccgo_up(z + uintptr(n+int32(5))))))
				if v1 == -int32(1) {
					v4 = 0
				} else {
					v4 = int32(**(**int8)(__ccgo_up(libc.X_ctype_ + libc.UintptrFromInt32(1) + uintptr(libc.Uint8FromInt32(v1))))) & int32(_CTYPE_S)
...
func findEndif(tls *libc.TLS, z uintptr, stopAtElse int32, pnLine uintptr) (r int32) {
	...
	for **(**int8)(__ccgo_up(z + uintptr(n))) != 0 {
		...
		if v5 = libc.Xstrncmp(tls, z+uintptr(n), __ccgo_ts+915, uint64(7)) == 0; v5 {
			v1 = libc.Int32FromUint8(libc.Uint8FromInt8(**(**int8)(__ccgo_up(z + uintptr(n+int32(7))))))
			if v1 == -int32(1) {
				v4 = 0
			} else {
				v4 = int32(**(**int8)(__ccgo_up(libc.X_ctype_ + libc.UintptrFromInt32(1) + uintptr(libc.Uint8FromInt32(v1))))) & int32(_CTYPE_S)
		...
		if v11 = v5 && v2 != 0; !v11 {
			if v10 = stopAtElse != 0 && libc.Xstrncmp(tls, z+uintptr(n), __ccgo_ts+923, uint64(6)) == 0; v10 {
				v6 = libc.Int32FromUint8(libc.Uint8FromInt8(**(**int8)(__ccgo_up(z + uintptr(n+int32(6))))))
				if v6 == -int32(1) {
					v9 = 0
				} else {
					v9 = int32(**(**int8)(__ccgo_up(libc.X_ctype_ + libc.UintptrFromInt32(1) + uintptr(libc.Uint8FromInt32(v6))))) & int32(_CTYPE_S)
				}
				v7 = v9
				goto _8
			_8:
		...
		if v5 = libc.Xstrncmp(tls, z+uintptr(n), __ccgo_ts+930, uint64(4)) == 0; v5 {
			v1 = libc.Int32FromUint8(libc.Uint8FromInt8(**(**int8)(__ccgo_up(z + uintptr(n+int32(4))))))
			if v1 == -int32(1) {
				v4 = 0
			} else {
				v4 = int32(**(**int8)(__ccgo_up(libc.X_ctype_ + libc.UintptrFromInt32(1) + uintptr(libc.Uint8FromInt32(v1))))) & int32(_CTYPE_S)
	...
	**(**int32)(__ccgo_up(bp)) = int32(1)
	...
	for {
		...
		if v1 == -int32(1) {
			...
			v3 = int32(**(**int8)(__ccgo_up(libc.X_ctype_ + libc.UintptrFromInt32(1) + uintptr(libc.Uint8FromInt32(v1))))) & int32(_CTYPE_S)
		}
		v2 = v3
		goto _4
	_4:
		;
		if v2 != 0 || c == int32('/') && int32(**(**int8)(__ccgo_up(zScript + uintptr(ii+int32(1))))) == int32('*') {
			ii = ii + len1
			continue
		}
		if v10 = c != int32('-') || int32(**(**int8)(__ccgo_up(zScript + uintptr(ii+int32(1))))) != int32('-'); !v10 {
			v1 = int32(**(**int8)(__ccgo_up(zScript + uintptr(ii+int32(2)))))
			if v1 == -int32(1) {
				v3 = 0
			} else {
				v3 = int32(**(**int8)(__ccgo_up(libc.X_ctype_ + libc.UintptrFromInt32(1) + uintptr(libc.Uint8FromInt32(v1))))) & (libc.Int32FromInt32(_CTYPE_U) | libc.Int32FromInt32(_CTYPE_L))
			}
			v2 = v3
			goto _8
		_8:
		...
		for {
			...
			for {
				if v10 = n < len1-int32(2); v10 {
					v1 = libc.Int32FromUint8(libc.Uint8FromInt8(**(**int8)(__ccgo_up(zScript + uintptr(ii+int32(2)+n)))))
					if v1 == -int32(1) {
						v3 = 0
					} else {
						v3 = int32(**(**int8)(__ccgo_up(libc.X_ctype_ + libc.UintptrFromInt32(1) + uintptr(libc.Uint8FromInt32(v1))))) & int32(_CTYPE_S)
							...
							if libc.Xstrcmp(tls, bp+24, __ccgo_ts+1253) == 0 {
								...
								for {
									if v10 = jj < len1-int32(1); v10 {
										v1 = libc.Int32FromUint8(libc.Uint8FromInt8(**(**int8)(__ccgo_up(zAns + uintptr(jj)))))
										if v1 == -int32(1) {
											v3 = 0
										} else {
											v3 = int32(**(**int8)(__ccgo_up(libc.X_ctype_ + libc.UintptrFromInt32(1) + uintptr(libc.Uint8FromInt32(v1))))) & int32(_CTYPE_S)
								...
								if libc.Xstrcmp(tls, bp+24, __ccgo_ts+1304) == 0 || libc.Xstrcmp(tls, bp+24, __ccgo_ts+1309) == 0 {
									...
									for {
										if v10 = jj1 < len1-int32(1); v10 {
											v1 = libc.Int32FromUint8(libc.Uint8FromInt8(**(**int8)(__ccgo_up(zAns1 + uintptr(jj1)))))
											if v1 == -int32(1) {
												v3 = 0
											} else {
												v3 = int32(**(**int8)(__ccgo_up(libc.X_ctype_ + libc.UintptrFromInt32(1) + uintptr(libc.Uint8FromInt32(v1))))) & int32(_CTYPE_S)
									...
									if libc.Xstrcmp(tls, bp+24, __ccgo_ts+1360) == 0 {
										...
										if libc.Xstrcmp(tls, bp+24, __ccgo_ts+1367) == 0 {
											...
											if !(int32(**(**int8)(__ccgo_up(zNewFile))) == libc.Int32FromUint8('/')) {
												...
												if k > 0 {
													v32 = libsqlite3.Xsqlite3_mprintf(tls, __ccgo_ts+1374, libc.VaList(bp+1264, k, zFilename, zNewFile))
													zToDel = v32
													zNewFile = v32
													if zNewFile == uintptr(0) {
														libc.Xfprintf(tls, uintptr(unsafe.Pointer(libc.Xstderr)), __ccgo_ts+1382, 0)
														libc.Xabort(tls)
													}
												}
											}
											...
											if libc.Xstrcmp(tls, bp+24, __ccgo_ts+1433) == 0 {
												...
												for {
													if v10 = jj2 < len1; v10 {
														v1 = libc.Int32FromUint8(libc.Uint8FromInt8(**(**int8)(__ccgo_up(zScript + uintptr(ii+jj2)))))
														if v1 == -int32(1) {
															v3 = 0
														} else {
															v3 = int32(**(**int8)(__ccgo_up(libc.X_ctype_ + libc.UintptrFromInt32(1) + uintptr(libc.Uint8FromInt32(v1))))) & int32(_CTYPE_S)
												...
												if libc.Xstrcmp(tls, bp+24, __ccgo_ts+1439) == 0 {
													...
													for {
														if v10 = jj3 < len1; v10 {
															v1 = libc.Int32FromUint8(libc.Uint8FromInt8(**(**int8)(__ccgo_up(zScript + uintptr(ii+jj3)))))
															if v1 == -int32(1) {
																v3 = 0
															} else {
																v3 = int32(**(**int8)(__ccgo_up(libc.X_ctype_ + libc.UintptrFromInt32(1) + uintptr(libc.Uint8FromInt32(v1))))) & int32(_CTYPE_S)
...
func usage(tls *libc.TLS, argv0 uintptr) {
	...
	libc.Xfprintf(tls, uintptr(unsafe.Pointer(libc.Xstderr)), __ccgo_ts+1706, libc.VaList(bp+8, zTail))
	libc.Xfprintf(tls, uintptr(unsafe.Pointer(libc.Xstderr)), __ccgo_ts+1745, 0)
	libc.Xexit(tls, int32(1))
}
...
func unrecognizedArguments(tls *libc.TLS, argv0 uintptr, nArg int32, azArg uintptr) {
	...
	var i int32
	_ = i
	libc.Xfprintf(tls, uintptr(unsafe.Pointer(libc.Xstderr)), __ccgo_ts+2317, libc.VaList(bp+8, argv0))
	i = 0
	for {
		if !(i < nArg) {
			break
		}
		libc.Xfprintf(tls, uintptr(unsafe.Pointer(libc.Xstderr)), __ccgo_ts+2345, libc.VaList(bp+8, **(**uintptr)(__ccgo_up(azArg + uintptr(i)*8))))
		goto _1
	_1:
		;
		i = i + 1
	}
	libc.Xfprintf(tls, uintptr(unsafe.Pointer(libc.Xstderr)), __ccgo_ts+2349, 0)
	libc.Xexit(tls, int32(1))
}
...
func main1(tls *libc.TLS, argc int32, argv uintptr) (r int32) {
	...
	if libc.Bool(0 != 0) && libc.Xstrcmp(tls, libsqlite3.Xsqlite3_sourceid(tls), __ccgo_ts+2358) != 0 {
		libc.Xfprintf(tls, uintptr(unsafe.Pointer(libc.Xstderr)), __ccgo_ts+2443, libc.VaList(bp+40, libsqlite3.Xsqlite3_sourceid(tls), __ccgo_ts+2358))
		libc.Xexit(tls, int32(1))
	}
