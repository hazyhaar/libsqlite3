...
func findEnd(tls *libc.TLS, z uintptr, pnLine uintptr) (r int32) {
	...
	for {
		if v10 = **(**int8)(__ccgo_up(z + uintptr(n))) != 0; v10 {
			if v9 = libc.Xstrncmp(tls, z+uintptr(n), __ccgo_ts+896, uint32(5)) != 0; !v9 {
...
func findEndif(tls *libc.TLS, z uintptr, stopAtElse int32, pnLine uintptr) (r int32) {
	...
	for **(**int8)(__ccgo_up(z + uintptr(n))) != 0 {
		...
		if v9 = libc.Xstrncmp(tls, z+uintptr(n), __ccgo_ts+902, uint32(7)) == 0; v9 {
		...
		if v19 = v9 && v1 != 0; !v19 {
			if v18 = stopAtElse != 0 && libc.Xstrncmp(tls, z+uintptr(n), __ccgo_ts+910, uint32(6)) == 0; v18 {
		...
		if v9 = libc.Xstrncmp(tls, z+uintptr(n), __ccgo_ts+917, uint32(4)) == 0; v9 {
						...
						if libc.Xstrcmp(tls, bp+16, __ccgo_ts+1234) == 0 {
							...
							if libc.Xstrcmp(tls, bp+16, __ccgo_ts+1240) == 0 {
								...
								if len1-jj-int32(1) != (**(**String)(__ccgo_up(bp + 4))).Fn || libc.Xstrncmp(tls, (**(**String)(__ccgo_up(bp + 4))).Fz, zAns, libc.Uint32FromInt32(len1-jj-int32(1))) != 0 {
									errorMessage(tls, __ccgo_ts+1246, libc.VaList(bp+1256, prevLine, zFilename, len1-jj-int32(1), zAns, (**(**String)(__ccgo_up(bp + 4))).Fz))
								}
								g.FnTest = g.FnTest + 1
								stringReset(tls, bp+4)
							} else {
								...
								if libc.Xstrcmp(tls, bp+16, __ccgo_ts+1291) == 0 || libc.Xstrcmp(tls, bp+16, __ccgo_ts+1296) == 0 {
									...
									if libc.BoolInt32(libsqlite3.Xsqlite3_strglob(tls, zCopy, (**(**String)(__ccgo_up(bp + 4))).Fz) == 0)^isGlob != 0 {
										errorMessage(tls, __ccgo_ts+1304, libc.VaList(bp+1256, prevLine, zFilename, zCopy, (**(**String)(__ccgo_up(bp + 4))).Fz))
									}
...
func unrecognizedArguments(tls *libc.TLS, argv0 uintptr, nArg int32, azArg uintptr) {
	...
	for {
		...
		libc.Xfprintf(tls, libc.X__stderrp, __ccgo_ts+2332, libc.VaList(bp+8, **(**uintptr)(__ccgo_up(azArg + uintptr(i)*4))))
		goto _1
	_1:
		;
		i = i + 1
...
func main1(tls *libc.TLS, argc int32, argv uintptr) (r int32) {
	...
	if libc.Bool(0 != 0) && libc.Xstrcmp(tls, libsqlite3.Xsqlite3_sourceid(tls), __ccgo_ts+2345) != 0 {
		libc.Xfprintf(tls, libc.X__stderrp, __ccgo_ts+2430, libc.VaList(bp+24, libsqlite3.Xsqlite3_sourceid(tls), __ccgo_ts+2345))
		libc.Xexit(tls, int32(1))
	}
	**(**int32)(__ccgo_up(bp)) = argc - int32(2)
	...
	if zClient != 0 {
		...
		nTry = 0
		if g.FiTrace > 0 {
			libc.Xprintf(tls, __ccgo_ts+2622, libc.VaList(bp+24, **(**uintptr)(__ccgo_up(argv))))
			i = int32(1)
			for {
				if !(i < argc) {
					break
				}
				libc.Xprintf(tls, __ccgo_ts+2332, libc.VaList(bp+24, **(**uintptr)(__ccgo_up(argv + uintptr(i)*4))))
				goto _1
			_1:
				;
				i = i + 1
	...
	if iClient > 0 {
		...
		for int32(1) != 0 {
			**(**uintptr)(__ccgo_up(bp + 12)) = uintptr(0)
			...
			if g.FiTrace != 0 {
				logMessage(tls, __ccgo_ts+2917, libc.VaList(bp+24, **(**uintptr)(__ccgo_up(bp + 12)), **(**int32)(__ccgo_up(bp + 8))))
			}
			runScript(tls, iClient, **(**int32)(__ccgo_up(bp + 8)), **(**uintptr)(__ccgo_up(bp + 4)), **(**uintptr)(__ccgo_up(bp + 12)))
			if g.FiTrace != 0 {
				logMessage(tls, __ccgo_ts+2931, libc.VaList(bp+24, **(**uintptr)(__ccgo_up(bp + 12)), **(**int32)(__ccgo_up(bp + 8))))
			}
		...
		**(**uintptr)(__ccgo_up(bp + 4)) = readFile(tls, **(**uintptr)(__ccgo_up(argv + 2*4)))
		...
		for {
			...
			if g.FiTrace != 0 {
				logMessage(tls, __ccgo_ts+3414, libc.VaList(bp+24, **(**uintptr)(__ccgo_up(argv + 2*4)), iRep))
			}
			runScript(tls, 0, 0, **(**uintptr)(__ccgo_up(bp + 4)), **(**uintptr)(__ccgo_up(argv + 2*4)))
			if g.FiTrace != 0 {
				logMessage(tls, __ccgo_ts+3442, libc.VaList(bp+24, **(**uintptr)(__ccgo_up(argv + 2*4)), iRep))
			}
			goto _8
		_8:
			;
	...
	if iClient == 0 {
		...
		libc.Xprintf(tls, __ccgo_ts+3609, libc.VaList(bp+24, **(**uintptr)(__ccgo_up(argv))))
		i = int32(1)
		for {
			if !(i < argc) {
				break
