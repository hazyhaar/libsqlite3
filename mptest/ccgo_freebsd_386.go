// Code generated for freebsd/386 by 'generator -D_GCC_NULLPTR_T -D_Float16=short -D__bf16=short -DNDEBUG -DSQLITE_DISABLE_INTRINSIC -I /tmp/libsqlite3/sqlite-src-3530400 -ignore-unsupported-alignment -ignore-link-errors -o mptest/ccgo_freebsd_386.go /tmp/libsqlite3/sqlite-src-3530400/mptest/mptest.c -lsqlite3', DO NOT EDIT.
		...
		if c == int32('*') {
			...
			if c == int32('?') {
				...
				if c == int32('[') {
					...
					if c == int32('#') {
						if v6 = int32(**(**int8)(__ccgo_up(z))) == int32('-') || int32(**(**int8)(__ccgo_up(z))) == int32('+'); v6 {
							v19 = libc.Int32FromUint8(libc.Uint8FromInt8(**(**int8)(__ccgo_up(z + 1))))
							if v19 < 0 || v19 >= libc.X__mb_sb_limit {
								...
								goto _24
							_24:
								v22 = **(**uint32)(__ccgo_up(v2 + 52 + uintptr(v19)*4)) & uint32(0x00000400)
							}
						...
						v19 = libc.Int32FromUint8(libc.Uint8FromInt8(**(**int8)(__ccgo_up(z))))
						if v19 < 0 || v19 >= libc.X__mb_sb_limit {
							v22 = uint32(0)
						} else {
							if libc.X_ThreadRuneLocale != 0 {
...
func clipLength(tls *libc.TLS, z uintptr) (r int32) {
	...
	for {
		if v9 = n > 0; v9 {
			v3 = libc.Int32FromUint8(libc.Uint8FromInt8(**(**int8)(__ccgo_up(z + uintptr(n-int32(1))))))
...
func stringAppendTerm(tls *libc.TLS, p uintptr, z uintptr) {
	...
	i = 0
	for {
		if v10 = **(**int8)(__ccgo_up(z + uintptr(i))) != 0; v10 {
			v4 = libc.Int32FromUint8(libc.Uint8FromInt8(**(**int8)(__ccgo_up(z + uintptr(i)))))
			if v4 < 0 || v4 >= libc.X__mb_sb_limit {
				...
				goto _9
			_9:
				v7 = **(**uint32)(__ccgo_up(v8 + 52 + uintptr(v4)*4)) & uint32(0x00004000)
			}
			v5 = libc.Int32FromUint32(v7)
			goto _6
		_6:
...
func tokenLength(tls *libc.TLS, z uintptr, pnLine uintptr) (r int32) {
	...
	n = 0
	v3 = libc.Int32FromUint8(libc.Uint8FromInt8(**(**int8)(__ccgo_up(z))))
	if v3 < 0 || v3 >= libc.X__mb_sb_limit {
		v6 = uint32(0)
	} else {
		if libc.X_ThreadRuneLocale != 0 {
...
_2:
	;
	if v1 != 0 || int32(**(**int8)(__ccgo_up(z))) == int32('/') && int32(**(**int8)(__ccgo_up(z + 1))) == int32('*') {
		inC = 0
		...
		for {
			v4 = n
			n = n + 1
			v1 = int32(**(**int8)(__ccgo_up(z + uintptr(v4))))
			c = v1
			if !(v1 != 0) {
				break
			}
...
func extractToken(tls *libc.TLS, zIn uintptr, nIn int32, zOut uintptr, nOut int32) (r int32) {
	...
	for {
		if v10 = i < nIn && i < nOut-int32(1); v10 {
			v4 = libc.Int32FromUint8(libc.Uint8FromInt8(**(**int8)(__ccgo_up(zIn + uintptr(i)))))
			if v4 < 0 || v4 >= libc.X__mb_sb_limit {
				v7 = uint32(0)
			} else {
				if libc.X_ThreadRuneLocale != 0 {
...
func findEnd(tls *libc.TLS, z uintptr, pnLine uintptr) (r int32) {
	...
	n = 0
	for {
		if v10 = **(**int8)(__ccgo_up(z + uintptr(n))) != 0; v10 {
			if v9 = libc.Xstrncmp(tls, z+uintptr(n), __ccgo_ts+909, uint32(5)) != 0; !v9 {
				v3 = libc.Int32FromUint8(libc.Uint8FromInt8(**(**int8)(__ccgo_up(z + uintptr(n+int32(5))))))
				if v3 < 0 || v3 >= libc.X__mb_sb_limit {
					v6 = uint32(0)
				} else {
					if libc.X_ThreadRuneLocale != 0 {
...
func findEndif(tls *libc.TLS, z uintptr, stopAtElse int32, pnLine uintptr) (r int32) {
	...
	for **(**int8)(__ccgo_up(z + uintptr(n))) != 0 {
		...
		if v9 = libc.Xstrncmp(tls, z+uintptr(n), __ccgo_ts+915, uint32(7)) == 0; v9 {
			v3 = libc.Int32FromUint8(libc.Uint8FromInt8(**(**int8)(__ccgo_up(z + uintptr(n+int32(7))))))
			if v3 < 0 || v3 >= libc.X__mb_sb_limit {
				v6 = uint32(0)
			} else {
				if libc.X_ThreadRuneLocale != 0 {
		...
		if v19 = v9 && v1 != 0; !v19 {
			if v18 = stopAtElse != 0 && libc.Xstrncmp(tls, z+uintptr(n), __ccgo_ts+923, uint32(6)) == 0; v18 {
				v12 = libc.Int32FromUint8(libc.Uint8FromInt8(**(**int8)(__ccgo_up(z + uintptr(n+int32(6))))))
				if v12 < 0 || v12 >= libc.X__mb_sb_limit {
					...
					goto _17
				_17:
					v15 = **(**uint32)(__ccgo_up(v16 + 52 + uintptr(v12)*4)) & uint32(0x00004000)
				}
				v13 = libc.Int32FromUint32(v15)
				goto _14
			_14:
		...
		if v9 = libc.Xstrncmp(tls, z+uintptr(n), __ccgo_ts+930, uint32(4)) == 0; v9 {
			v3 = libc.Int32FromUint8(libc.Uint8FromInt8(**(**int8)(__ccgo_up(z + uintptr(n+int32(4))))))
			if v3 < 0 || v3 >= libc.X__mb_sb_limit {
				v6 = uint32(0)
			} else {
				if libc.X_ThreadRuneLocale != 0 {
...
func runScript(tls *libc.TLS, iClient int32, taskId int32, zScript uintptr, zFilename uintptr) {
	...
	**(**int32)(__ccgo_up(bp)) = int32(1)
	...
	_3:
		;
		if v1 != 0 || c == int32('/') && int32(**(**int8)(__ccgo_up(zScript + uintptr(ii+int32(1))))) == int32('*') {
			ii = ii + len1
			continue
		}
		if v18 = c != int32('-') || int32(**(**int8)(__ccgo_up(zScript + uintptr(ii+int32(1))))) != int32('-'); !v18 {
			v4 = int32(**(**int8)(__ccgo_up(zScript + uintptr(ii+int32(2)))))
			if v4 < 0 || v4 >= libc.X__mb_sb_limit {
				v7 = uint32(0)
			} else {
				if libc.X_ThreadRuneLocale != 0 {
				...
				goto _17
			_17:
				v7 = **(**uint32)(__ccgo_up(v8 + 52 + uintptr(v4)*4)) & uint32(0x00000100)
			}
			v2 = libc.Int32FromUint32(v7)
			goto _14
		_14:
		...
		for {
			...
			for {
				if v18 = n < len1-int32(2); v18 {
					v4 = libc.Int32FromUint8(libc.Uint8FromInt8(**(**int8)(__ccgo_up(zScript + uintptr(ii+int32(2)+n)))))
					if v4 < 0 || v4 >= libc.X__mb_sb_limit {
						v7 = uint32(0)
					} else {
						if libc.X_ThreadRuneLocale != 0 {
		...
		for {
			...
			v1 = j
			j = j + 1
			**(**int8)(__ccgo_up(bp + 1046 + uintptr(v1)*100)) = 0
			goto _29
		_29:
			;
			j = j + 1
							...
							if libc.Xstrcmp(tls, bp+16, __ccgo_ts+1253) == 0 {
								...
								for {
									if v18 = jj < len1-int32(1); v18 {
										v4 = libc.Int32FromUint8(libc.Uint8FromInt8(**(**int8)(__ccgo_up(zAns + uintptr(jj)))))
										if v4 < 0 || v4 >= libc.X__mb_sb_limit {
											v7 = uint32(0)
										} else {
											if libc.X_ThreadRuneLocale != 0 {
								...
								if len1-jj-int32(1) != (**(**String)(__ccgo_up(bp + 4))).Fn || libc.Xstrncmp(tls, (**(**String)(__ccgo_up(bp + 4))).Fz, zAns, libc.Uint32FromInt32(len1-jj-int32(1))) != 0 {
									errorMessage(tls, __ccgo_ts+1259, libc.VaList(bp+1256, prevLine, zFilename, len1-jj-int32(1), zAns, (**(**String)(__ccgo_up(bp + 4))).Fz))
								}
								g.FnTest = g.FnTest + 1
								stringReset(tls, bp+4)
							} else {
								...
								if libc.Xstrcmp(tls, bp+16, __ccgo_ts+1304) == 0 || libc.Xstrcmp(tls, bp+16, __ccgo_ts+1309) == 0 {
									...
									isGlob = libc.BoolInt32(int32((**(**[30]int8)(__ccgo_up(bp + 16)))[0]) == int32('g'))
									jj1 = int32(9) - int32(3)*isGlob
									for {
										if v18 = jj1 < len1-int32(1); v18 {
											v4 = libc.Int32FromUint8(libc.Uint8FromInt8(**(**int8)(__ccgo_up(zAns1 + uintptr(jj1)))))
											if v4 < 0 || v4 >= libc.X__mb_sb_limit {
												v7 = uint32(0)
											} else {
												if libc.X_ThreadRuneLocale != 0 {
									...
									if libc.BoolInt32(libsqlite3.Xsqlite3_strglob(tls, zCopy, (**(**String)(__ccgo_up(bp + 4))).Fz) == 0)^isGlob != 0 {
										errorMessage(tls, __ccgo_ts+1317, libc.VaList(bp+1256, prevLine, zFilename, zCopy, (**(**String)(__ccgo_up(bp + 4))).Fz))
									}
									...
									if libc.Xstrcmp(tls, bp+16, __ccgo_ts+1360) == 0 {
										logMessage(tls, __ccgo_ts+438, libc.VaList(bp+1256, (**(**String)(__ccgo_up(bp + 4))).Fz))
									} else {
										/*
										 **  --source FILENAME
										 **
										...
										if libc.Xstrcmp(tls, bp+16, __ccgo_ts+1367) == 0 {
											...
											if !(int32(**(**int8)(__ccgo_up(zNewFile))) == libc.Int32FromUint8('/')) {
												...
												if k > 0 {
													v8 = libsqlite3.Xsqlite3_mprintf(tls, __ccgo_ts+1374, libc.VaList(bp+1256, k, zFilename, zNewFile))
													zToDel = v8
													zNewFile = v8
											...
											if libc.Xstrcmp(tls, bp+16, __ccgo_ts+1433) == 0 {
												...
												for {
													if v18 = jj2 < len1; v18 {
														v4 = libc.Int32FromUint8(libc.Uint8FromInt8(**(**int8)(__ccgo_up(zScript + uintptr(ii+jj2)))))
														if v4 < 0 || v4 >= libc.X__mb_sb_limit {
															v7 = uint32(0)
														} else {
															if libc.X_ThreadRuneLocale != 0 {
												...
												if libc.Xstrcmp(tls, bp+16, __ccgo_ts+1439) == 0 {
													...
													for {
														if v18 = jj3 < len1; v18 {
															v4 = libc.Int32FromUint8(libc.Uint8FromInt8(**(**int8)(__ccgo_up(zScript + uintptr(ii+jj3)))))
															if v4 < 0 || v4 >= libc.X__mb_sb_limit {
																v7 = uint32(0)
															} else {
																if libc.X_ThreadRuneLocale != 0 {
...
func unrecognizedArguments(tls *libc.TLS, argv0 uintptr, nArg int32, azArg uintptr) {
	...
	for {
		...
		libc.Xfprintf(tls, libc.X__stderrp, __ccgo_ts+2345, libc.VaList(bp+8, **(**uintptr)(__ccgo_up(azArg + uintptr(i)*4))))
		goto _1
	_1:
		;
		i = i + 1
...
func main1(tls *libc.TLS, argc int32, argv uintptr) (r int32) {
	...
	if libc.Bool(0 != 0) && libc.Xstrcmp(tls, libsqlite3.Xsqlite3_sourceid(tls), __ccgo_ts+2358) != 0 {
		libc.Xfprintf(tls, libc.X__stderrp, __ccgo_ts+2443, libc.VaList(bp+24, libsqlite3.Xsqlite3_sourceid(tls), __ccgo_ts+2358))
		libc.Xexit(tls, int32(1))
	}
	**(**int32)(__ccgo_up(bp)) = argc - int32(2)
	...
	if zClient != 0 {
		...
		nTry = 0
		if g.FiTrace > 0 {
			libc.Xprintf(tls, __ccgo_ts+2635, libc.VaList(bp+24, **(**uintptr)(__ccgo_up(argv))))
			i = int32(1)
			for {
				if !(i < argc) {
					break
				}
				libc.Xprintf(tls, __ccgo_ts+2345, libc.VaList(bp+24, **(**uintptr)(__ccgo_up(argv + uintptr(i)*4))))
				goto _1
			_1:
				;
				i = i + 1
	...
	if iClient > 0 {
		if **(**int32)(__ccgo_up(bp)) > 0 {
			unrecognizedArguments(tls, **(**uintptr)(__ccgo_up(argv)), **(**int32)(__ccgo_up(bp)), argv+uintptr(2)*4)
		}
		if g.FiTrace != 0 {
		...
		for int32(1) != 0 {
			**(**uintptr)(__ccgo_up(bp + 12)) = uintptr(0)
			...
			if g.FiTrace != 0 {
				logMessage(tls, __ccgo_ts+2930, libc.VaList(bp+24, **(**uintptr)(__ccgo_up(bp + 12)), **(**int32)(__ccgo_up(bp + 8))))
			}
			runScript(tls, iClient, **(**int32)(__ccgo_up(bp + 8)), **(**uintptr)(__ccgo_up(bp + 4)), **(**uintptr)(__ccgo_up(bp + 12)))
			if g.FiTrace != 0 {
				logMessage(tls, __ccgo_ts+2944, libc.VaList(bp+24, **(**uintptr)(__ccgo_up(bp + 12)), **(**int32)(__ccgo_up(bp + 8))))
			}
			finishScript(tls, iClient, **(**int32)(__ccgo_up(bp + 8)), 0)
			libsqlite3.Xsqlite3_free(tls, **(**uintptr)(__ccgo_up(bp + 12)))
			libsqlite3.Xsqlite3_sleep(tls, int32(10))
		}
		if g.FiTrace != 0 {
		...
		**(**uintptr)(__ccgo_up(bp + 4)) = readFile(tls, **(**uintptr)(__ccgo_up(argv + 2*4)))
		iRep = int32(1)
		for {
			if !(iRep <= nRep) {
				break
			...
			if g.FiTrace != 0 {
				logMessage(tls, __ccgo_ts+3427, libc.VaList(bp+24, **(**uintptr)(__ccgo_up(argv + 2*4)), iRep))
			}
			runScript(tls, 0, 0, **(**uintptr)(__ccgo_up(bp + 4)), **(**uintptr)(__ccgo_up(argv + 2*4)))
			if g.FiTrace != 0 {
				logMessage(tls, __ccgo_ts+3455, libc.VaList(bp+24, **(**uintptr)(__ccgo_up(argv + 2*4)), iRep))
			}
			goto _9
		_9:
			;
		...
		libsqlite3.Xsqlite3_free(tls, **(**uintptr)(__ccgo_up(bp + 4)))
	...
	if iClient == 0 {
		...
		libc.Xprintf(tls, __ccgo_ts+3622, libc.VaList(bp+24, **(**uintptr)(__ccgo_up(argv))))
		i = int32(1)
		for {
			if !(i < argc) {
				break
