		...
		if c == int32('*') {
			...
			if c == int32('?') {
				...
				if c == int32('[') {
					...
					if c == int32('#') {
						if (int32(**(**int8)(__ccgo_up(z))) == int32('-') || int32(**(**int8)(__ccgo_up(z))) == int32('+')) && libc.Xisdigit(tls, int32(uint8(**(**int8)(__ccgo_up(z + 1))))) != 0 {
							z = z + 1
						}
						if !(libc.Xisdigit(tls, int32(uint8(**(**int8)(__ccgo_up(z))))) != 0) {
							return 0
						}
						z = z + 1
						for libc.Xisdigit(tls, int32(uint8(**(**int8)(__ccgo_up(z))))) != 0 {
							z = z + 1
						}
					} else {
						v2 = z
...
func clipLength(tls *libc.TLS, z uintptr) (r int32) {
	...
	for n > 0 && libc.Xisspace(tls, int32(uint8(**(**int8)(__ccgo_up(z + uintptr(n-int32(1))))))) != 0 {
		n = n - 1
	}
	return n
}
...
func stringAppendTerm(tls *libc.TLS, p uintptr, z uintptr) {
	...
	i = 0
	for {
		if !(**(**int8)(__ccgo_up(z + uintptr(i))) != 0 && !(libc.Xisspace(tls, int32(uint8(**(**int8)(__ccgo_up(z + uintptr(i)))))) != 0)) {
			break
		}
		goto _1
	_1:
...
func evalCallback(tls *libc.TLS, pCData uintptr, argc int32, argv uintptr, azCol uintptr) (r int32) {
	...
	for {
		...
		stringAppendTerm(tls, p, **(**uintptr)(__ccgo_up(argv + uintptr(i)*4)))
		goto _1
	_1:
		;
		i = i + 1
...
func startClient(tls *libc.TLS, iClient int32) {
	...
	if libsqlite3.Xsqlite3_changes(tls, g.Fdb) != 0 {
		...
		(**(**STARTUPINFOA)(__ccgo_up(bp))).Fcb = uint32(68)
		...
		if rc != 0 {
			libc.XCloseHandle(tls, (**(**PROCESS_INFORMATION)(__ccgo_up(bp + 68))).FhThread)
			libc.XCloseHandle(tls, (**(**PROCESS_INFORMATION)(__ccgo_up(bp + 68))).FhProcess)
		} else {
...
func tokenLength(tls *libc.TLS, z uintptr, pnLine uintptr) (r int32) {
	...
	n = 0
	if libc.Xisspace(tls, int32(uint8(**(**int8)(__ccgo_up(z))))) != 0 || int32(**(**int8)(__ccgo_up(z))) == int32('/') && int32(**(**int8)(__ccgo_up(z + 1))) == int32('*') {
		inC = 0
...
func extractToken(tls *libc.TLS, zIn uintptr, nIn int32, zOut uintptr, nOut int32) (r int32) {
	...
	i = 0
	for {
		if !(i < nIn && i < nOut-int32(1) && !(libc.Xisspace(tls, int32(uint8(**(**int8)(__ccgo_up(zIn + uintptr(i)))))) != 0)) {
			break
		}
...
func findEnd(tls *libc.TLS, z uintptr, pnLine uintptr) (r int32) {
	...
	_ = n
	n = 0
	for **(**int8)(__ccgo_up(z + uintptr(n))) != 0 && (libc.Xstrncmp(tls, z+uintptr(n), __ccgo_ts+913, uint32(5)) != 0 || !(libc.Xisspace(tls, int32(uint8(**(**int8)(__ccgo_up(z + uintptr(n+int32(5))))))) != 0)) {
...
func findEndif(tls *libc.TLS, z uintptr, stopAtElse int32, pnLine uintptr) (r int32) {
	...
	for **(**int8)(__ccgo_up(z + uintptr(n))) != 0 {
		...
		if libc.Xstrncmp(tls, z+uintptr(n), __ccgo_ts+919, uint32(7)) == 0 && libc.Xisspace(tls, int32(uint8(**(**int8)(__ccgo_up(z + uintptr(n+int32(7))))))) != 0 || stopAtElse != 0 && libc.Xstrncmp(tls, z+uintptr(n), __ccgo_ts+927, uint32(6)) == 0 && libc.Xisspace(tls, int32(uint8(**(**int8)(__ccgo_up(z + uintptr(n+int32(6))))))) != 0 {
			return n + len1
		}
		if libc.Xstrncmp(tls, z+uintptr(n), __ccgo_ts+934, uint32(4)) == 0 && libc.Xisspace(tls, int32(uint8(**(**int8)(__ccgo_up(z + uintptr(n+int32(4))))))) != 0 {
...
func filenameTail(tls *libc.TLS, z uintptr) (r uintptr) {
	...
	for {
		...
		if int32(**(**int8)(__ccgo_up(z + uintptr(i)))) == int32('/') || int32(**(**int8)(__ccgo_up(z + uintptr(i)))) == int32('\\') {
			j = i + int32(1)
		}
		goto _1
	_1:
...
func runScript(tls *libc.TLS, iClient int32, taskId int32, zScript uintptr, zFilename uintptr) {
	...
	**(**int32)(__ccgo_up(bp + 16)) = int32(1)
	...
	for {
		...
		prevLine = **(**int32)(__ccgo_up(bp + 16))
		len1 = tokenLength(tls, zScript+uintptr(ii), bp+16)
		if libc.Xisspace(tls, int32(uint8(c))) != 0 || c == int32('/') && int32(**(**int8)(__ccgo_up(zScript + uintptr(ii+int32(1))))) == int32('*') {
			ii = ii + len1
			continue
		}
		if c != int32('-') || int32(**(**int8)(__ccgo_up(zScript + uintptr(ii+int32(1))))) != int32('-') || !(libc.Xisalpha(tls, int32(**(**int8)(__ccgo_up(zScript + uintptr(ii+int32(2)))))) != 0) {
			ii = ii + len1
			continue
		}
		...
		for {
			...
			for n < len1-int32(2) && libc.Xisspace(tls, int32(uint8(**(**int8)(__ccgo_up(zScript + uintptr(ii+int32(2)+n)))))) != 0 {
				n = n + 1
			}
			if n >= len1-int32(2) {
				break
		...
		for {
			...
			v1 = j
			j = j + 1
			**(**int8)(__ccgo_up(bp + 1062 + uintptr(v1)*100)) = 0
			goto _3
		_3:
			;
			j = j + 1
					...
					if libc.Xstrcmp(tls, bp+32, __ccgo_ts+1244) == 0 && iClient > 0 {
						...
						if libc.Xstrcmp(tls, bp+32, __ccgo_ts+1251) == 0 {
							...
							if libc.Xstrcmp(tls, bp+32, __ccgo_ts+1257) == 0 {
								...
								jj = int32(7)
								for {
									if !(jj < len1-int32(1) && libc.Xisspace(tls, int32(uint8(**(**int8)(__ccgo_up(zAns + uintptr(jj)))))) != 0) {
										break
									}
									goto _5
								_5:
								...
								if len1-jj-int32(1) != (**(**String)(__ccgo_up(bp + 20))).Fn || libc.Xstrncmp(tls, (**(**String)(__ccgo_up(bp + 20))).Fz, zAns, uint32(len1-jj-int32(1))) != 0 {
									errorMessage(tls, __ccgo_ts+1263, libc.VaList(bp+1272, prevLine, zFilename, len1-jj-int32(1), zAns, (**(**String)(__ccgo_up(bp + 20))).Fz))
								}
								g.FnTest = g.FnTest + 1
								stringReset(tls, bp+20)
							} else {
								...
								if libc.Xstrcmp(tls, bp+32, __ccgo_ts+1308) == 0 || libc.Xstrcmp(tls, bp+32, __ccgo_ts+1313) == 0 {
									...
									isGlob = libc.BoolInt32(int32((**(**[30]int8)(__ccgo_up(bp + 32)))[0]) == int32('g'))
									jj1 = int32(9) - int32(3)*isGlob
									for {
										if !(jj1 < len1-int32(1) && libc.Xisspace(tls, int32(uint8(**(**int8)(__ccgo_up(zAns1 + uintptr(jj1)))))) != 0) {
											break
										}
										goto _6
									_6:
									...
									if libc.BoolInt32(libsqlite3.Xsqlite3_strglob(tls, zCopy, (**(**String)(__ccgo_up(bp + 20))).Fz) == 0)^isGlob != 0 {
										errorMessage(tls, __ccgo_ts+1321, libc.VaList(bp+1272, prevLine, zFilename, zCopy, (**(**String)(__ccgo_up(bp + 20))).Fz))
									}
									...
									if libc.Xstrcmp(tls, bp+32, __ccgo_ts+1364) == 0 {
										logMessage(tls, __ccgo_ts+438, libc.VaList(bp+1272, (**(**String)(__ccgo_up(bp + 20))).Fz))
									} else {
										/*
										 **  --source FILENAME
										 **
										...
										if libc.Xstrcmp(tls, bp+32, __ccgo_ts+1371) == 0 {
											zToDel = uintptr(0)
											zNewFile = bp + 1062
											if !(int32(**(**int8)(__ccgo_up(zNewFile))) == int32('/') || int32(**(**int8)(__ccgo_up(zNewFile))) == int32('\\')) {
												k = int32(libc.Xstrlen(tls, zFilename)) - int32(1)
												for {
													if !(k >= 0 && !(int32(**(**int8)(__ccgo_up(zFilename + uintptr(k)))) == int32('/') || int32(**(**int8)(__ccgo_up(zFilename + uintptr(k)))) == int32('\\'))) {
														break
													}
													goto _7
												_7:
											...
											if libc.Xstrcmp(tls, bp+32, __ccgo_ts+1437) == 0 {
												jj2 = int32(7)
												for {
													if !(jj2 < len1 && libc.Xisspace(tls, int32(uint8(**(**int8)(__ccgo_up(zScript + uintptr(ii+jj2)))))) != 0) {
														break
													}
													goto _11
												_11:
												...
												if libc.Xstrcmp(tls, bp+32, __ccgo_ts+1443) == 0 {
													jj3 = int32(4)
													for {
														if !(jj3 < len1 && libc.Xisspace(tls, int32(uint8(**(**int8)(__ccgo_up(zScript + uintptr(ii+jj3)))))) != 0) {
															break
														}
														goto _12
													_12:
...
func findOption(tls *libc.TLS, azArg uintptr, pnArg uintptr, zOption uintptr, hasArg int32) (r uintptr) {
	...
	for {
		...
		z = **(**uintptr)(__ccgo_up(azArg + uintptr(i)*4))
		if int32(**(**int8)(__ccgo_up(z))) != int32('-') {
			goto _1
		}
		z = z + 1
		...
		if libc.Xstrcmp(tls, z, zOption) == 0 {
			...
			if hasArg != 0 {
				zReturn = **(**uintptr)(__ccgo_up(azArg + uintptr(i+int32(1))*4))
			} else {
				zReturn = **(**uintptr)(__ccgo_up(azArg + uintptr(i)*4))
			}
			...
			for j < nArg {
				...
				v3 = j
				j = j + 1
				**(**uintptr)(__ccgo_up(azArg + uintptr(v2)*4)) = **(**uintptr)(__ccgo_up(azArg + uintptr(v3)*4))
			}
...
func usage(tls *libc.TLS, argv0 uintptr) {
	...
	for {
		...
		if int32(**(**int8)(__ccgo_up(argv0 + uintptr(i)))) == int32('/') || int32(**(**int8)(__ccgo_up(argv0 + uintptr(i)))) == int32('\\') {
...
_2:
	...
	for {
		...
		v1 = __ccgo_ts + 2349
		libc.VaList(bp+32, **(**uintptr)(__ccgo_up(azArg + uintptr(i)*4)))
		__local_argv = bp + 32
		__retval = libc.X__mingw_vfprintf(tls, libc.X__acrt_iob_func(tls, uint32(2)), v1, __local_argv)
		_ = __local_argv
		_ = __retval
...
func main1(tls *libc.TLS, argc int32, argv uintptr) (r int32) {
	...
	var _ /* taskId at bp+344 */ int32
	var _ /* zScript at bp+340 */ uintptr
	var _ /* zTaskName at bp+348 */ uintptr
	...
	g.FzDbFile = **(**uintptr)(__ccgo_up(argv + 1*4))
	if strglob(tls, __ccgo_ts+2355, g.FzDbFile) != 0 {
		usage(tls, **(**uintptr)(__ccgo_up(argv)))
	}
	if libc.Bool(0 != 0) && libc.Xstrcmp(tls, libsqlite3.Xsqlite3_sourceid(tls), __ccgo_ts+2362) != 0 {
		v1 = __ccgo_ts + 2447
	...
	**(**int32)(__ccgo_up(bp + 336)) = argc - int32(2)
	libsqlite3.Xsqlite3_snprintf(tls, int32(32), uintptr(unsafe.Pointer(&g))+32, __ccgo_ts+2507, libc.VaList(bp+360, int32(libc.XGetCurrentProcessId(tls))))
	zJMode = findOption(tls, argv+uintptr(2)*4, bp+336, __ccgo_ts+2519, int32(1))
	zNRep = findOption(tls, argv+uintptr(2)*4, bp+336, __ccgo_ts+2531, int32(1))
	if zNRep != 0 {
	...
	g.FzVfs = findOption(tls, argv+uintptr(2)*4, bp+336, __ccgo_ts+2538, int32(1))
	zClient = findOption(tls, argv+uintptr(2)*4, bp+336, __ccgo_ts+2542, int32(1))
	g.FzErrLog = findOption(tls, argv+uintptr(2)*4, bp+336, __ccgo_ts+2549, int32(1))
	g.FzLog = findOption(tls, argv+uintptr(2)*4, bp+336, __ccgo_ts+2556, int32(1))
	zTrace = findOption(tls, argv+uintptr(2)*4, bp+336, __ccgo_ts+2560, int32(1))
	if zTrace != 0 {
		g.FiTrace = libc.Xatoi(tls, zTrace)
	}
	if findOption(tls, argv+uintptr(2)*4, bp+336, __ccgo_ts+2566, 0) != uintptr(0) {
		g.FiTrace = 0
	}
	zTmout = findOption(tls, argv+uintptr(2)*4, bp+336, __ccgo_ts+2572, int32(1))
	if zTmout != 0 {
		iTmout = libc.Xatoi(tls, zTmout)
	}
	g.FbSqlTrace = libc.BoolInt32(findOption(tls, argv+uintptr(2)*4, bp+336, __ccgo_ts+2580, 0) != uintptr(0))
	g.FbSync = libc.BoolInt32(findOption(tls, argv+uintptr(2)*4, bp+336, __ccgo_ts+2589, 0) != uintptr(0))
	if g.FzErrLog != 0 {
	...
	libsqlite3.Xsqlite3_config(tls, int32(SQLITE_CONFIG_LOG), libc.VaList(bp+360, __ccgo_fp(sqlErrorCallback), 0))
	if zClient != 0 {
		iClient = libc.Xatoi(tls, zClient)
		if iClient < int32(1) {
			fatalError(tls, __ccgo_ts+2596, libc.VaList(bp+360, iClient))
		}
		libsqlite3.Xsqlite3_snprintf(tls, int32(32), uintptr(unsafe.Pointer(&g))+32, __ccgo_ts+2623, libc.VaList(bp+360, int32(libc.XGetCurrentProcessId(tls)), iClient))
	} else {
		nTry = 0
		if g.FiTrace > 0 {
			v1 = __ccgo_ts + 2639
		...
		_4:
			...
			for {
				...
				v1 = __ccgo_ts + 2349
				libc.VaList(bp+64, **(**uintptr)(__ccgo_up(argv + uintptr(i)*4)))
				__local_argv1 = bp + 64
				__retval1 = libc.X__mingw_vfprintf(tls, libc.X__acrt_iob_func(tls, uint32(1)), v1, __local_argv1)
				_ = __local_argv1
				_ = __retval1
		...
		for {
			...
			if rc != 0 && **(**int32)(__ccgo_up(libc.X_errno(tls))) == int32(ENOENT) {
				rc = 0
			}
			goto _18
		_18:
		...
		if rc != 0 {
			fatalError(tls, __ccgo_ts+2803, libc.VaList(bp+360, g.FzDbFile, nTry))
		}
	...
	if rc != 0 {
		fatalError(tls, __ccgo_ts+2844, libc.VaList(bp+360, g.FzDbFile))
	}
	if iTmout > 0 {
	...
	if zJMode != 0 {
		...
		runSql(tls, __ccgo_ts+2925, libc.VaList(bp+360, zJMode))
	}
	if !(g.FbSync != 0) {
	...
	if iClient > 0 {
		if **(**int32)(__ccgo_up(bp + 336)) > 0 {
			unrecognizedArguments(tls, **(**uintptr)(__ccgo_up(argv)), **(**int32)(__ccgo_up(bp + 336)), argv+uintptr(2)*4)
		}
		if g.FiTrace != 0 {
			logMessage(tls, __ccgo_ts+2985, 0)
		}
		for int32(1) != 0 {
			**(**uintptr)(__ccgo_up(bp + 348)) = uintptr(0)
			rc = startScript(tls, iClient, bp+340, bp+344, bp+348)
			if rc == int32(SQLITE_DONE) {
				break
			}
			if g.FiTrace != 0 {
				logMessage(tls, __ccgo_ts+2998, libc.VaList(bp+360, **(**uintptr)(__ccgo_up(bp + 348)), **(**int32)(__ccgo_up(bp + 344))))
			}
			runScript(tls, iClient, **(**int32)(__ccgo_up(bp + 344)), **(**uintptr)(__ccgo_up(bp + 340)), **(**uintptr)(__ccgo_up(bp + 348)))
			if g.FiTrace != 0 {
				logMessage(tls, __ccgo_ts+3012, libc.VaList(bp+360, **(**uintptr)(__ccgo_up(bp + 348)), **(**int32)(__ccgo_up(bp + 344))))
			}
			finishScript(tls, iClient, **(**int32)(__ccgo_up(bp + 344)), 0)
			libsqlite3.Xsqlite3_free(tls, **(**uintptr)(__ccgo_up(bp + 348)))
			libsqlite3.Xsqlite3_sleep(tls, int32(10))
		}
		if g.FiTrace != 0 {
		...
		**(**uintptr)(__ccgo_up(bp + 340)) = readFile(tls, **(**uintptr)(__ccgo_up(argv + 2*4)))
		iRep = int32(1)
		for {
			if !(iRep <= nRep) {
				break
			...
			if g.FiTrace != 0 {
				logMessage(tls, __ccgo_ts+3495, libc.VaList(bp+360, **(**uintptr)(__ccgo_up(argv + 2*4)), iRep))
			}
			runScript(tls, 0, 0, **(**uintptr)(__ccgo_up(bp + 340)), **(**uintptr)(__ccgo_up(argv + 2*4)))
			if g.FiTrace != 0 {
				logMessage(tls, __ccgo_ts+3523, libc.VaList(bp+360, **(**uintptr)(__ccgo_up(argv + 2*4)), iRep))
			}
			goto _25
		_25:
			;
		...
		libsqlite3.Xsqlite3_free(tls, **(**uintptr)(__ccgo_up(bp + 340)))
	...
	_31:
		...
		for {
			...
			v1 = __ccgo_ts + 2349
			libc.VaList(bp+288, **(**uintptr)(__ccgo_up(argv + uintptr(i)*4)))
