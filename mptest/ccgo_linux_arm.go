// Code generated for linux/arm by 'generator -D_GCC_NULLPTR_T -D_Float16=short -D__bf16=short -DNDEBUG -DSQLITE_DISABLE_INTRINSIC -I /tmp/libsqlite3/sqlite-src-3530400 -ignore-unsupported-alignment -ignore-link-errors -o mptest/ccgo_linux_arm.go /tmp/libsqlite3/sqlite-src-3530400/mptest/mptest.c -lsqlite3', DO NOT EDIT.
		...
		if c == int32('*') {
			...
			if c == int32('?') {
				...
				if c == int32('[') {
					...
					if c == int32('#') {
						if (libc.Int32FromUint8(**(**uint8)(__ccgo_up(z))) == int32('-') || libc.Int32FromUint8(**(**uint8)(__ccgo_up(z))) == int32('+')) && libc.BoolInt32(uint32(uint8(**(**uint8)(__ccgo_up(z + 1))))-uint32('0') < uint32(10)) != 0 {
							z = z + 1
						}
						if !(libc.BoolInt32(uint32(uint8(**(**uint8)(__ccgo_up(z))))-libc.Uint32FromUint8('0') < libc.Uint32FromInt32(10)) != 0) {
							return 0
						}
						z = z + 1
						for libc.BoolInt32(uint32(uint8(**(**uint8)(__ccgo_up(z))))-uint32('0') < uint32(10)) != 0 {
							z = z + 1
						}
					} else {
						v2 = z
...
func stringAppendTerm(tls *libc.TLS, p uintptr, z uintptr) {
	...
	i = 0
	for {
		if v5 = **(**uint8)(__ccgo_up(z + uintptr(i))) != 0; v5 {
...
func findEnd(tls *libc.TLS, z uintptr, pnLine uintptr) (r int32) {
	...
	n = 0
	for {
		if v5 = **(**uint8)(__ccgo_up(z + uintptr(n))) != 0; v5 {
	...
	for **(**uint8)(__ccgo_up(z + uintptr(n))) != 0 {
		...
		if v9 = v4 && v2 != 0; !v9 {
			if v8 = stopAtElse != 0 && libc.Xstrncmp(tls, z+uintptr(n), __ccgo_ts+923, uint32(6)) == 0; v8 {
				v5 = libc.Int32FromUint8(uint8(**(**uint8)(__ccgo_up(z + uintptr(n+int32(6))))))
...
func runScript(tls *libc.TLS, iClient int32, taskId int32, zScript uintptr, zFilename uintptr) {
	...
	**(**int32)(__ccgo_up(bp)) = int32(1)
	...
	_4:
		...
		if c != int32('-') || libc.Int32FromUint8(**(**uint8)(__ccgo_up(zScript + uintptr(ii+int32(1))))) != int32('-') || !(libc.BoolInt32(uint32(**(**uint8)(__ccgo_up(zScript + uintptr(ii+int32(2)))))|libc.Uint32FromInt32(32)-libc.Uint32FromUint8('a') < libc.Uint32FromInt32(26)) != 0) {
			ii = ii + len1
			continue
		}
		...
		for {
			...
			v1 = j
			j = j + 1
			**(**uint8)(__ccgo_up(bp + 1046 + uintptr(v1)*100)) = uint8(0)
			goto _10
		_10:
			;
			j = j + 1
						...
						if libc.Xstrcmp(tls, bp+16, __ccgo_ts+1247) == 0 {
							...
							if libc.Xstrcmp(tls, bp+16, __ccgo_ts+1253) == 0 {
								...
								if libc.Xstrcmp(tls, bp+16, __ccgo_ts+1304) == 0 || libc.Xstrcmp(tls, bp+16, __ccgo_ts+1309) == 0 {
									...
									isGlob = libc.BoolInt32(libc.Int32FromUint8((**(**[30]uint8)(__ccgo_up(bp + 16)))[0]) == int32('g'))
