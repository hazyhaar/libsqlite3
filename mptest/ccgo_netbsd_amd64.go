...
func findEnd(tls *libc.TLS, z uintptr, pnLine uintptr) (r int32) {
	...
	_ = n
	n = 0
	for **(**int8)(__ccgo_up(z + uintptr(n))) != 0 && (libc.Xstrncmp(tls, z+uintptr(n), __ccgo_ts+896, uint64(5)) != 0 || !(libc.Int32FromUint16(**(**uint16)(__ccgo_up(libc.X_ctype_tab_ + libc.UintptrFromInt32(1)*2 + uintptr(libc.Uint8FromInt8(**(**int8)(__ccgo_up(z + uintptr(n+int32(5))))))*2)))&libc.Int32FromInt32(_CTYPE_S) != 0)) {
...
func findEndif(tls *libc.TLS, z uintptr, stopAtElse int32, pnLine uintptr) (r int32) {
	...
	for **(**int8)(__ccgo_up(z + uintptr(n))) != 0 {
		...
		if libc.Xstrncmp(tls, z+uintptr(n), __ccgo_ts+902, uint64(7)) == 0 && libc.Int32FromUint16(**(**uint16)(__ccgo_up(libc.X_ctype_tab_ + libc.UintptrFromInt32(1)*2 + uintptr(libc.Uint8FromInt8(**(**int8)(__ccgo_up(z + uintptr(n+int32(7))))))*2)))&libc.Int32FromInt32(_CTYPE_S) != 0 || stopAtElse != 0 && libc.Xstrncmp(tls, z+uintptr(n), __ccgo_ts+910, uint64(6)) == 0 && libc.Int32FromUint16(**(**uint16)(__ccgo_up(libc.X_ctype_tab_ + libc.UintptrFromInt32(1)*2 + uintptr(libc.Uint8FromInt8(**(**int8)(__ccgo_up(z + uintptr(n+int32(6))))))*2)))&libc.Int32FromInt32(_CTYPE_S) != 0 {
			return n + len1
		}
		if libc.Xstrncmp(tls, z+uintptr(n), __ccgo_ts+917, uint64(4)) == 0 && libc.Int32FromUint16(**(**uint16)(__ccgo_up(libc.X_ctype_tab_ + libc.UintptrFromInt32(1)*2 + uintptr(libc.Uint8FromInt8(**(**int8)(__ccgo_up(z + uintptr(n+int32(4))))))*2)))&libc.Int32FromInt32(_CTYPE_S) != 0 {
											...
											if !(int32(**(**int8)(__ccgo_up(zNewFile))) == libc.Int32FromUint8('/')) {
												...
												if k > 0 {
													...
													if zNewFile == uintptr(0) {
														libc.Xfprintf(tls, uintptr(unsafe.Pointer(&libc.X__sF))+2*152, __ccgo_ts+1369, 0)
														libc.Xabort(tls)
													}
												}
											}
...
func usage(tls *libc.TLS, argv0 uintptr) {
	...
	libc.Xfprintf(tls, uintptr(unsafe.Pointer(&libc.X__sF))+2*152, __ccgo_ts+1693, libc.VaList(bp+8, zTail))
	libc.Xfprintf(tls, uintptr(unsafe.Pointer(&libc.X__sF))+2*152, __ccgo_ts+1732, 0)
	libc.Xexit(tls, int32(1))
}
...
func unrecognizedArguments(tls *libc.TLS, argv0 uintptr, nArg int32, azArg uintptr) {
	...
	var i int32
	_ = i
	libc.Xfprintf(tls, uintptr(unsafe.Pointer(&libc.X__sF))+2*152, __ccgo_ts+2304, libc.VaList(bp+8, argv0))
	i = 0
	for {
		if !(i < nArg) {
			break
		}
		libc.Xfprintf(tls, uintptr(unsafe.Pointer(&libc.X__sF))+2*152, __ccgo_ts+2332, libc.VaList(bp+8, **(**uintptr)(__ccgo_up(azArg + uintptr(i)*8))))
		goto _1
	_1:
		;
		i = i + 1
	}
	libc.Xfprintf(tls, uintptr(unsafe.Pointer(&libc.X__sF))+2*152, __ccgo_ts+2336, 0)
	libc.Xexit(tls, int32(1))
}
...
func main1(tls *libc.TLS, argc int32, argv uintptr) (r int32) {
	...
	if libc.Bool(0 != 0) && libc.Xstrcmp(tls, libsqlite3.Xsqlite3_sourceid(tls), __ccgo_ts+2345) != 0 {
		libc.Xfprintf(tls, uintptr(unsafe.Pointer(&libc.X__sF))+2*152, __ccgo_ts+2430, libc.VaList(bp+40, libsqlite3.Xsqlite3_sourceid(tls), __ccgo_ts+2345))
		libc.Xexit(tls, int32(1))
	}
