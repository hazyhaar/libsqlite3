// Code generated for freebsd/arm by 'generator -DNDEBUG -DSQLITE_DISABLE_INTRINSIC -DSQLITE_ENABLE_DBPAGE_VTAB -DSQLITE_ENABLE_RTREE -ignore-unsupported-alignment -ignore-link-errors -o speedtest1/ccgo_freebsd_arm.go -I /tmp/l3genarm/sqlite-src-3530200 /tmp/l3genarm/sqlite-src-3530200/test/speedtest1.c -lsqlite3', DO NOT EDIT.
...
func HashInit(tls *libc.TLS) {
	...
	for {
		...
		**(**uint8)(__ccgo_up(uintptr(unsafe.Pointer(&g)) + 3132 + 3 + uintptr(k))) = uint8(k)
		goto _1
	_1:
		;
		k = k + 1
...
func HashUpdate(tls *libc.TLS, aData uintptr, nData uint32) {
	...
	for {
		...
		j = libc.Uint8FromInt32(int32(j) + (libc.Int32FromUint8(**(**uint8)(__ccgo_up(uintptr(unsafe.Pointer(&g)) + 3132 + 3 + uintptr(i)))) + libc.Int32FromUint8(**(**uint8)(__ccgo_up(aData + uintptr(k))))))
		t = **(**uint8)(__ccgo_up(uintptr(unsafe.Pointer(&g)) + 3132 + 3 + uintptr(j)))
		**(**uint8)(__ccgo_up(uintptr(unsafe.Pointer(&g)) + 3132 + 3 + uintptr(j))) = **(**uint8)(__ccgo_up(uintptr(unsafe.Pointer(&g)) + 3132 + 3 + uintptr(i)))
		**(**uint8)(__ccgo_up(uintptr(unsafe.Pointer(&g)) + 3132 + 3 + uintptr(i))) = t
		i = i + 1
		goto _1
	_1:
		;
...
func HashFinal(tls *libc.TLS) {
	...
	for {
		...
		i = i + 1
		t = **(**uint8)(__ccgo_up(uintptr(unsafe.Pointer(&g)) + 3132 + 3 + uintptr(i)))
		j = libc.Uint8FromInt32(int32(j) + libc.Int32FromUint8(t))
		**(**uint8)(__ccgo_up(uintptr(unsafe.Pointer(&g)) + 3132 + 3 + uintptr(i))) = **(**uint8)(__ccgo_up(uintptr(unsafe.Pointer(&g)) + 3132 + 3 + uintptr(j)))
		**(**uint8)(__ccgo_up(uintptr(unsafe.Pointer(&g)) + 3132 + 3 + uintptr(j))) = t
		t = libc.Uint8FromInt32(int32(t) + libc.Int32FromUint8(**(**uint8)(__ccgo_up(uintptr(unsafe.Pointer(&g)) + 3132 + 3 + uintptr(i)))))
		**(**uint8)(__ccgo_up(uintptr(unsafe.Pointer(&g)) + 3132 + 259 + uintptr(k))) = **(**uint8)(__ccgo_up(uintptr(unsafe.Pointer(&g)) + 3132 + 3 + uintptr(t)))
		goto _1
	_1:
		;
		k = k + 1
...
func integerValue(tls *libc.TLS, zArg uintptr) (r int32) {
	...
	if libc.Int32FromUint8(**(**uint8)(__ccgo_up(zArg))) == int32('0') && libc.Int32FromUint8(**(**uint8)(__ccgo_up(zArg + 1))) == int32('x') {
		zArg = zArg + uintptr(2)
		for {
			v1 = hexDigitValue(tls, **(**uint8)(__ccgo_up(zArg)))
			x = v1
			if !(v1 >= 0) {
				break
			}
		...
		for {
			v4 = libc.Int32FromUint8(**(**uint8)(__ccgo_up(zArg)))
			if v4 < 0 || v4 >= libc.X__mb_sb_limit {
				...
				goto _9
			_9:
				v7 = **(**uint32)(__ccgo_up(v8 + 52 + uintptr(v4)*4)) & uint32(0x00000400)
			}
			v2 = libc.Int32FromUint32(v7)
			goto _6
		_6:
		...
		_3:
			...
			v = v*int64(10) + libc.Int64FromUint8(**(**uint8)(__ccgo_up(zArg))) - int64('0')
			zArg = zArg + 1
		}
	}
	i = 0
...
func speedtest1_timestamp(tls *libc.TLS) (r sqlite3_int64) {
	...
	if (*sqlite3_vfs)(unsafe.Pointer(clockVfs)).FiVersion >= int32(2) && (*sqlite3_vfs)(unsafe.Pointer(clockVfs)).FxCurrentTimeInt64 != uintptr(0) {
		...
		**(**sqlite3_int64)(__ccgo_up(bp)) = int64(float64(**(**float64)(__ccgo_up(bp + 8)) * libc.Float64FromFloat64(8.64e+07)))
	}
	return **(**sqlite3_int64)(__ccgo_up(bp))
}
...
func speedtest1_begin_test(tls *libc.TLS, iTestNum int32, zTestName uintptr, va uintptr) {
	...
	if n > int32(NAMEWIDTH) {
		**(**uint8)(__ccgo_up(zName + 60)) = uint8(0)
		n = int32(NAMEWIDTH)
	}
	if g.FpScript != 0 {
...
func speedtest1_final(tls *libc.TLS) {
	...
	if g.FbVerify != 0 {
		...
		for {
			...
			libc.Xprintf(tls, __ccgo_ts+459, libc.VaList(bp+8, libc.Int32FromUint8(**(**uint8)(__ccgo_up(uintptr(unsafe.Pointer(&g)) + 3132 + 259 + uintptr(i))))))
			goto _1
		_1:
			;
			i = i + 1
...
func printSql(tls *libc.TLS, zSql uintptr) {
	...
	for {
		if v10 = n > 0; v10 {
			if v9 = libc.Int32FromUint8(**(**uint8)(__ccgo_up(zSql + uintptr(n-int32(1))))) == int32(';'); !v9 {
				v3 = libc.Int32FromUint8(uint8(**(**uint8)(__ccgo_up(zSql + uintptr(n-int32(1))))))
				if v3 < 0 || v3 >= libc.X__mb_sb_limit {
					...
					goto _8
				_8:
					v6 = **(**uint32)(__ccgo_up(v7 + 52 + uintptr(v3)*4)) & uint32(0x00004000)
				}
				v4 = libc.Int32FromUint32(v6)
				goto _5
			_5:
	...
	if g.FbSqlOnly != 0 {
		...
		**(**uintptr)(__ccgo_up(bp)) = uintptr(0)
		...
		if **(**uintptr)(__ccgo_up(bp)) != 0 {
			fatal_error(tls, __ccgo_ts+509, libc.VaList(bp+16, **(**uintptr)(__ccgo_up(bp)), zSql))
		}
		if rc != SQLITE_OK {
...
func speedtest1_once(tls *libc.TLS, zFormat uintptr, va uintptr) (r uintptr) {
	...
	if g.FbSqlOnly != 0 {
		...
		if g.FpScript != 0 {
			z = libsqlite3.Xsqlite3_expanded_sql(tls, **(**uintptr)(__ccgo_up(bp)))
			libc.Xfprintf(tls, g.FpScript, __ccgo_ts+558, libc.VaList(bp+16, z))
			libsqlite3.Xsqlite3_free(tls, z)
		}
		if libsqlite3.Xsqlite3_step(tls, **(**uintptr)(__ccgo_up(bp))) == int32(SQLITE_ROW) {
			z1 = libsqlite3.Xsqlite3_column_text(tls, **(**uintptr)(__ccgo_up(bp)), 0)
			if z1 != 0 {
				zResult = libsqlite3.Xsqlite3_mprintf(tls, __ccgo_ts+294, libc.VaList(bp+16, z1))
			}
		}
		rc1 = libsqlite3.Xsqlite3_reset(tls, **(**uintptr)(__ccgo_up(bp)))
		if rc1 != SQLITE_OK {
			fatal_error(tls, __ccgo_ts+562, libc.VaList(bp+16, libsqlite3.Xsqlite3_sql(tls, **(**uintptr)(__ccgo_up(bp))), rc1, libsqlite3.Xsqlite3_errmsg(tls, g.Fdb)))
		}
...
func speedtest1_run(tls *libc.TLS) {
	...
	for libsqlite3.Xsqlite3_step(tls, g.FpStmt) == int32(SQLITE_ROW) {
		...
		for {
			...
			if g.FbVerify != 0 {
				...
				(**(**[2]uint8)(__ccgo_up(bp)))[0] = uint8('\n')
				(**(**[2]uint8)(__ccgo_up(bp)))[int32(1)] = uint8(**(**uint8)(__ccgo_up(__ccgo_ts + 588 + uintptr(eType))))
				if g.FnResByte != 0 {
				...
				if eType == int32(SQLITE_FLOAT) {
					...
					if eType == int32(SQLITE_BLOB) {
						...
						for {
							...
							(**(**[2]uint8)(__ccgo_up(bp + 2)))[0] = uint8(**(**uint8)(__ccgo_up(__ccgo_ts + 595 + uintptr(libc.Int32FromUint8(**(**uint8)(__ccgo_up(aBlob + uintptr(iBlob))))>>int32(4)))))
							(**(**[2]uint8)(__ccgo_up(bp + 2)))[int32(1)] = uint8(**(**uint8)(__ccgo_up(__ccgo_ts + 595 + uintptr(libc.Int32FromUint8(**(**uint8)(__ccgo_up(aBlob + uintptr(iBlob))))&int32(15)))))
			...
			if libc.Uint32FromInt32(g.FnResult+len1) < libc.Uint32FromInt64(3000)-libc.Uint32FromInt32(2) {
				if g.FnResult > 0 {
					...
					**(**uint8)(__ccgo_up(uintptr(unsafe.Pointer(&g)) + 124 + uintptr(v3))) = uint8(' ')
				}
	...
	if g.FbReprepare != 0 {
		...
		if rc != SQLITE_OK {
			fatal_error(tls, __ccgo_ts+562, libc.VaList(bp+16, libsqlite3.Xsqlite3_sql(tls, **(**uintptr)(__ccgo_up(bp + 4))), rc, libsqlite3.Xsqlite3_errmsg(tls, g.Fdb)))
		}
		g.FpStmt = **(**uintptr)(__ccgo_up(bp + 4))
	} else {
...
func testset_main(tls *libc.TLS) {
	...
	n = v1
	sz = v1
	(**(**[2000]uint8)(__ccgo_up(bp)))[0] = uint8(0)
	...
	for {
		...
		if (i-int32(1))%g.FnRepeat == 0 {
			x1 = speedtest1_random(tls) % libc.Uint32FromInt32(maxb)
			(**(**[2000]uint8)(__ccgo_up(bp)))[0] = uint8('%')
			...
			(**(**[2000]uint8)(__ccgo_up(bp)))[len1] = uint8('%')
			(**(**[2000]uint8)(__ccgo_up(bp)))[len1+int32(1)] = uint8(0)
		}
...
func testset_app(tls *libc.TLS) {
	...
	for {
		...
		dbMain = g.Fdb
		**(**uintptr)(__ccgo_up(bp)) = uintptr(0)
		if g.FzDbName != 0 && **(**uint8)(__ccgo_up(g.FzDbName)) != 0 {
		...
		libsqlite3.Xsqlite3_close(tls, **(**uintptr)(__ccgo_up(bp)))
		g.Fdb = dbMain
		goto _1
	_1:
		;
...
func twoCoords(tls *libc.TLS, p1 int32, p2 int32, mx uint32, pX0 uintptr, pX1 uintptr) {
	...
	x1 = x0 + d
	**(**uint32)(__ccgo_up(pX0)) = x0
	**(**uint32)(__ccgo_up(pX1)) = x1
}
...
func xsliceGeometryCallback(tls *libc.TLS, p uintptr, nCoord int32, aCoord uintptr, pRes uintptr) (r int32) {
	**(**int32)(__ccgo_up(pRes)) = libc.BoolInt32(**(**float64)(__ccgo_up(aCoord + 3*8)) >= **(**sqlite3_rtree_dbl)(__ccgo_up((*sqlite3_rtree_geometry)(unsafe.Pointer(p)).FaParam)) && **(**float64)(__ccgo_up(aCoord + 2*8)) <= **(**sqlite3_rtree_dbl)(__ccgo_up((*sqlite3_rtree_geometry)(unsafe.Pointer(p)).FaParam + 1*8)))
	return SQLITE_OK
}
...
func testset_rtree(tls *libc.TLS, p1 int32, p2 int32) {
	...
	for {
		...
		libsqlite3.Xsqlite3_bind_int(tls, g.FpStmt, int32(2), libc.Int32FromUint32(**(**uint32)(__ccgo_up(bp))))
		libsqlite3.Xsqlite3_bind_int(tls, g.FpStmt, int32(3), libc.Int32FromUint32(**(**uint32)(__ccgo_up(bp + 4))))
		libsqlite3.Xsqlite3_bind_int(tls, g.FpStmt, int32(4), libc.Int32FromUint32(**(**uint32)(__ccgo_up(bp + 8))))
		libsqlite3.Xsqlite3_bind_int(tls, g.FpStmt, int32(5), libc.Int32FromUint32(**(**uint32)(__ccgo_up(bp + 12))))
		libsqlite3.Xsqlite3_bind_int(tls, g.FpStmt, int32(6), libc.Int32FromUint32(**(**uint32)(__ccgo_up(bp + 16))))
		libsqlite3.Xsqlite3_bind_int(tls, g.FpStmt, int32(7), libc.Int32FromUint32(**(**uint32)(__ccgo_up(bp + 20))))
		speedtest1_run(tls)
		goto _2
	_2:
		;
	...
	for {
		...
		speedtest1_run(tls)
		**(**int32)(__ccgo_up(aCheck + uintptr(i)*4)) = libc.Xatoi(tls, uintptr(unsafe.Pointer(&g))+124)
		goto _3
	_3:
		;
		i = i + 1
	...
	if g.FbVerify != 0 {
		...
		for {
			...
			libsqlite3.Xsqlite3_bind_int(tls, g.FpStmt, int32(2), libc.Int32FromUint32((i+uint32(1))*iStep))
			speedtest1_run(tls)
			if **(**int32)(__ccgo_up(aCheck + uintptr(i)*4)) != libc.Xatoi(tls, uintptr(unsafe.Pointer(&g))+124) {
				fatal_error(tls, __ccgo_ts+20845, libc.VaList(bp+32, i, i*iStep, (i+uint32(1))*iStep, **(**int32)(__ccgo_up(aCheck + uintptr(i)*4)), libc.Xatoi(tls, uintptr(unsafe.Pointer(&g))+124)))
			}
			goto _4
		_4:
			;
...
func xCompileOptions(tls *libc.TLS, pCtx uintptr, nVal int32, azVal uintptr, azCol uintptr) (r int32) {
	bp := tls.Alloc(16)
	defer tls.Free(16)
	libc.Xprintf(tls, __ccgo_ts+36491, libc.VaList(bp+8, **(**uintptr)(__ccgo_up(azVal))))
	return SQLITE_OK
}
...
func main1(tls *libc.TLS, argc int32, argv uintptr) (r int32) {
	...
	for {
		...
		z = **(**uintptr)(__ccgo_up(argv + uintptr(i)*4))
		if libc.Int32FromUint8(**(**uint8)(__ccgo_up(z))) == int32('-') {
			for cond := true; cond; cond = libc.Int32FromUint8(**(**uint8)(__ccgo_up(z))) == int32('-') {
				z = z + 1
			}
			if libc.Xstrcmp(tls, z, __ccgo_ts+36561) == 0 {
				...
				if libc.Xstrcmp(tls, z, __ccgo_ts+36572) == 0 {
					...
					if libc.Xstrcmp(tls, z, __ccgo_ts+36589) == 0 {
						if i >= argc-int32(1) {
							fatal_error(tls, __ccgo_ts+36599, libc.VaList(bp+16, **(**uintptr)(__ccgo_up(argv + uintptr(i)*4))))
						}
						i = i + 1
						v2 = i
						cacheSize = integerValue(tls, **(**uintptr)(__ccgo_up(argv + uintptr(v2)*4)))
					} else {
								...
								if libc.Xstrcmp(tls, z, __ccgo_ts+36643) == 0 {
									...
									if libc.Xstrcmp(tls, z, __ccgo_ts+36654) == 0 {
										...
										if libc.Xstrcmp(tls, z, __ccgo_ts+36662) == 0 {
											...
											nHardHeapLmt = integerValue(tls, **(**uintptr)(__ccgo_up(argv + uintptr(i+int32(1))*4)))
											i = i + int32(1)
										} else {
											if libc.Xstrcmp(tls, z, __ccgo_ts+36678) == 0 {
												...
												nHeap = integerValue(tls, **(**uintptr)(__ccgo_up(argv + uintptr(i+int32(1))*4)))
												mnHeap = integerValue(tls, **(**uintptr)(__ccgo_up(argv + uintptr(i+int32(2))*4)))
												i = i + int32(2)
											} else {
												if libc.Xstrcmp(tls, z, __ccgo_ts+36683) == 0 {
													...
													if libc.Xstrcmp(tls, z, __ccgo_ts+36694) == 0 {
														...
														i = i + 1
														v2 = i
														zJMode = **(**uintptr)(__ccgo_up(argv + uintptr(v2)*4))
													} else {
														if libc.Xstrcmp(tls, z, __ccgo_ts+36702) == 0 {
															...
															i = i + 1
															v2 = i
															zKey = **(**uintptr)(__ccgo_up(argv + uintptr(v2)*4))
														} else {
															if libc.Xstrcmp(tls, z, __ccgo_ts+36706) == 0 {
																if i >= argc-int32(2) {
																	fatal_error(tls, __ccgo_ts+36599, libc.VaList(bp+16, **(**uintptr)(__ccgo_up(argv + uintptr(i)*4))))
																}
																nLook = integerValue(tls, **(**uintptr)(__ccgo_up(argv + uintptr(i+int32(1))*4)))
																szLook = integerValue(tls, **(**uintptr)(__ccgo_up(argv + uintptr(i+int32(2))*4)))
																i = i + int32(2)
															} else {
																	...
																	if libc.Xstrcmp(tls, z, __ccgo_ts+36722) == 0 {
																		...
																		if libc.Xstrcmp(tls, z, __ccgo_ts+36734) == 0 {
																			...
																			if libc.Xstrcmp(tls, z, __ccgo_ts+36744) == 0 {
																				...
																				i = i + 1
																				v2 = i
																				mmapSize = integerValue(tls, **(**uintptr)(__ccgo_up(argv + uintptr(v2)*4)))
																			} else {
																					...
																					if libc.Xstrcmp(tls, z, __ccgo_ts+36757) == 0 {
																						...
																						if libc.Xstrcmp(tls, z, __ccgo_ts+36764) == 0 {
																							...
																							if libc.Xstrcmp(tls, z, __ccgo_ts+36781) == 0 {
																								...
																								i = i + 1
																								if libc.Xstrcmp(tls, **(**uintptr)(__ccgo_up(argv + uintptr(i)*4)), __ccgo_ts+36788) == 0 {
																									g.FhashFile = libc.X__stdoutp
																								} else {
																									g.FhashFile = libc.Xfopen(tls, **(**uintptr)(__ccgo_up(argv + uintptr(i)*4)), __ccgo_ts+36790)
																									if g.FhashFile == uintptr(0) {
																										fatal_error(tls, __ccgo_ts+36793, libc.VaList(bp+16, **(**uintptr)(__ccgo_up(argv + uintptr(i)*4))))
																									}
																								}
																							} else {
																								if libc.Xstrcmp(tls, z, __ccgo_ts+36823) == 0 {
																									...
																									i = i + 1
																									v2 = i
																									pageSize = integerValue(tls, **(**uintptr)(__ccgo_up(argv + uintptr(v2)*4)))
																								} else {
																									if libc.Xstrcmp(tls, z, __ccgo_ts+36832) == 0 {
																										if i >= argc-int32(2) {
																											fatal_error(tls, __ccgo_ts+36599, libc.VaList(bp+16, **(**uintptr)(__ccgo_up(argv + uintptr(i)*4))))
																										}
																										nPCache = integerValue(tls, **(**uintptr)(__ccgo_up(argv + uintptr(i+int32(1))*4)))
																										szPCache = integerValue(tls, **(**uintptr)(__ccgo_up(argv + uintptr(i+int32(2))*4)))
																										doPCache = int32(1)
																										i = i + int32(2)
																									} else {
																										if libc.Xstrcmp(tls, z, __ccgo_ts+36839) == 0 {
																											...
																											if libc.Xstrcmp(tls, z, __ccgo_ts+36862) == 0 {
																												...
																												i = i + 1
																												v2 = i
																												g.FnRepeat = integerValue(tls, **(**uintptr)(__ccgo_up(argv + uintptr(v2)*4)))
																											} else {
																													...
																													if libc.Xstrcmp(tls, z, __ccgo_ts+36879) == 0 {
																														...
																														if libc.Xstrcmp(tls, z, __ccgo_ts+36890) == 0 {
																															...
																															if libc.Xstrcmp(tls, z, __ccgo_ts+36903) == 0 {
																																...
																																i = i + 1
																																v2 = i
																																g.FpScript = libc.Xfopen(tls, **(**uintptr)(__ccgo_up(argv + uintptr(v2)*4)), __ccgo_ts+36790)
																																if g.FpScript == uintptr(0) {
																																	fatal_error(tls, __ccgo_ts+36910, libc.VaList(bp+16, **(**uintptr)(__ccgo_up(argv + uintptr(i)*4))))
																																}
																															} else {
																																if libc.Xstrcmp(tls, z, __ccgo_ts+36943) == 0 {
																																	...
																																	if libc.Xstrcmp(tls, z, __ccgo_ts+36951) == 0 {
																																		...
																																		if libc.Xstrcmp(tls, z, __ccgo_ts+36965) == 0 {
																																			...
																																			i = i + 1
																																			v3 = i
																																			v2 = integerValue(tls, **(**uintptr)(__ccgo_up(argv + uintptr(v3)*4)))
																																			g.FszBase = v2
																																			g.FszTest = v2
																																		} else {
																																			if libc.Xstrcmp(tls, z, __ccgo_ts+36970) == 0 {
																																				...
																																				nSoftHeapLmt = integerValue(tls, **(**uintptr)(__ccgo_up(argv + uintptr(i+int32(1))*4)))
																																				i = i + int32(1)
																																			} else {
																																				if libc.Xstrcmp(tls, z, __ccgo_ts+36986) == 0 {
																																					...
																																					if libc.Xstrcmp(tls, z, __ccgo_ts+36992) == 0 {
																																						...
																																						i = i + 1
																																						if libc.Int32FromUint8(**(**uint8)(__ccgo_up(**(**uintptr)(__ccgo_up(argv + uintptr(i)*4))))) < int32('0') || libc.Int32FromUint8(**(**uint8)(__ccgo_up(**(**uintptr)(__ccgo_up(argv + uintptr(i)*4))))) > int32('9') || libc.Int32FromUint8(**(**uint8)(__ccgo_up(**(**uintptr)(__ccgo_up(argv + uintptr(i)*4)) + 1))) != 0 {
																																							fatal_error(tls, __ccgo_ts+36997, 0)
																																						}
																																						g.FeTemp = libc.Int32FromUint8(**(**uint8)(__ccgo_up(**(**uintptr)(__ccgo_up(argv + uintptr(i)*4))))) - int32('0')
																																					} else {
																																						if libc.Xstrcmp(tls, z, __ccgo_ts+37050) == 0 {
																																							...
																																							i = i + 1
																																							v2 = i
																																							zTSet = **(**uintptr)(__ccgo_up(argv + uintptr(v2)*4))
																																						} else {
																																							if libc.Xstrcmp(tls, z, __ccgo_ts+37058) == 0 {
																																								...
																																								if libc.Xstrcmp(tls, z, __ccgo_ts+37064) == 0 {
																																									...
																																									i = i + 1
																																									v2 = i
																																									nThread = integerValue(tls, **(**uintptr)(__ccgo_up(argv + uintptr(v2)*4)))
																																								} else {
																																										...
																																										if libc.Xstrcmp(tls, z, __ccgo_ts+37080) == 0 {
																																											...
																																											if libc.Xstrcmp(tls, z, __ccgo_ts+37088) == 0 {
																																												...
																																												if libc.Xstrcmp(tls, z, __ccgo_ts+37095) == 0 {
																																													...
																																													i = i + 1
																																													v2 = i
																																													g.FzVfs = **(**uintptr)(__ccgo_up(argv + uintptr(v2)*4))
																																												} else {
																																													if libc.Xstrcmp(tls, z, __ccgo_ts+37099) == 0 {
																																														...
																																														i = i + 1
																																														v2 = i
																																														g.FnReserve = libc.Xatoi(tls, **(**uintptr)(__ccgo_up(argv + uintptr(v2)*4)))
																																													} else {
																																															...
																																															if libc.Xstrcmp(tls, z, __ccgo_ts+37122) == 0 {
																																																...
																																																if libc.Xstrcmp(tls, z, __ccgo_ts+37172) == 0 {
																																																	...
																																																	if libc.Xstrcmp(tls, z, __ccgo_ts+37179) == 0 || libc.Xstrcmp(tls, z, __ccgo_ts+37184) == 0 {
																																																		libc.Xprintf(tls, uintptr(unsafe.Pointer(&zHelp)), libc.VaList(bp+16, **(**uintptr)(__ccgo_up(argv))))
																																																		libc.Xexit(tls, 0)
																																																	} else {
																																																		fatal_error(tls, __ccgo_ts+37186, libc.VaList(bp+16, **(**uintptr)(__ccgo_up(argv + uintptr(i)*4)), **(**uintptr)(__ccgo_up(argv))))
																																																	}
																																																}
																																															}
																																														}
			...
			if g.FzDbName == uintptr(0) {
				g.FzDbName = **(**uintptr)(__ccgo_up(argv + uintptr(i)*4))
			} else {
				fatal_error(tls, __ccgo_ts+37227, libc.VaList(bp+16, **(**uintptr)(__ccgo_up(argv + uintptr(i)*4)), **(**uintptr)(__ccgo_up(argv))))
			}
		}
		goto _1
	_1:
	...
	for cond := true; cond; cond = **(**uint8)(__ccgo_up(zTSet)) != 0 {
		zThisTest = zTSet
		zComma = libc.Xstrchr(tls, zThisTest, int32(','))
		if zComma != 0 {
			**(**uint8)(__ccgo_up(zComma)) = uint8(0)
		...
		if zSep != 0 {
			kk = int32(1)
			for {
				if v25 = **(**uint8)(__ccgo_up(zSep + uintptr(kk))) != 0; v25 {
					v19 = libc.Int32FromUint8(uint8(**(**uint8)(__ccgo_up(zSep + uintptr(kk)))))
					if v19 < 0 || v19 >= libc.X__mb_sb_limit {
						...
						goto _24
					_24:
						v22 = **(**uint32)(__ccgo_up(v15 + 52 + uintptr(v19)*4)) & uint32(0x00000400)
					}
					v3 = libc.Int32FromUint32(v22)
					goto _21
				_21:
			...
			if kk == int32(1) || libc.Int32FromUint8(**(**uint8)(__ccgo_up(zSep + uintptr(kk)))) != 0 {
	...
	if showStats != 0 {
		...
		libc.Xprintf(tls, __ccgo_ts+38596, libc.VaList(bp+16, **(**int32)(__ccgo_up(bp)), **(**int32)(__ccgo_up(bp + 4))))
		libsqlite3.Xsqlite3_status(tls, int32(SQLITE_STATUS_MALLOC_COUNT), bp, bp+4, 0)
		libc.Xprintf(tls, __ccgo_ts+38641, libc.VaList(bp+16, **(**int32)(__ccgo_up(bp)), **(**int32)(__ccgo_up(bp + 4))))
		libsqlite3.Xsqlite3_status(tls, int32(SQLITE_STATUS_PAGECACHE_OVERFLOW), bp, bp+4, 0)
		libc.Xprintf(tls, __ccgo_ts+38686, libc.VaList(bp+16, **(**int32)(__ccgo_up(bp)), **(**int32)(__ccgo_up(bp + 4))))
		libsqlite3.Xsqlite3_status(tls, int32(SQLITE_STATUS_MALLOC_SIZE), bp, bp+4, 0)
		libc.Xprintf(tls, __ccgo_ts+38731, libc.VaList(bp+16, **(**int32)(__ccgo_up(bp + 4))))
		libsqlite3.Xsqlite3_status(tls, int32(SQLITE_STATUS_PAGECACHE_SIZE), bp, bp+4, 0)
		libc.Xprintf(tls, __ccgo_ts+38773, libc.VaList(bp+16, **(**int32)(__ccgo_up(bp + 4))))
	}
	if g.FpScript != 0 {
		libc.Xfclose(tls, g.FpScript)
	}
