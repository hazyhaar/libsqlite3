// Code generated for windows/amd64 by 'generator --cpp /usr/bin/x86_64-w64-mingw32-gcc --goarch amd64 --goos windows -DNDEBUG -DSQLITE_DISABLE_INTRINSIC -DSQLITE_ENABLE_DBPAGE_VTAB -DSQLITE_OMIT_SEH -DSQLITE_OS_WIN=1 -DSQLITE_ENABLE_RTREE -I /tmp/libsqlite3/sqlite-src-3530400 -build-lines \/\/go:build windows && (amd64 || arm64)\n\/\/ \x2bbuild windows\n\/\/ \x2bbuild amd64 arm64 -map gcc=x86_64-w64-mingw32-gcc -o speedtest1/ccgo_windows.go /tmp/libsqlite3/sqlite-src-3530400/test/speedtest1.c -lsqlite3', DO NOT EDIT.
...
func HashUpdate(tls *libc.TLS, aData uintptr, nData uint32) {
	...
	for {
		...
		j = uint8(int32(j) + (int32(**(**uint8)(__ccgo_up(uintptr(unsafe.Pointer(&g)) + 3168 + 3 + uintptr(i)))) + int32(**(**uint8)(__ccgo_up(aData + uintptr(k))))))
...
func HashFinal(tls *libc.TLS) {
	...
	for {
		...
		**(**uint8)(__ccgo_up(uintptr(unsafe.Pointer(&g)) + 3168 + 3 + uintptr(j))) = t
		t = uint8(int32(t) + int32(**(**uint8)(__ccgo_up(uintptr(unsafe.Pointer(&g)) + 3168 + 3 + uintptr(i)))))
...
func speedtest1_run(tls *libc.TLS) {
		...
		for {
			...
			if uint64(g.FnResult+len1) < libc.Uint64FromInt64(3000)-libc.Uint64FromInt32(2) {
				if g.FnResult > 0 {
					...
					**(**int8)(__ccgo_up(uintptr(unsafe.Pointer(&g)) + 148 + uintptr(v5))) = int8(' ')
				}
	...
	if g.FbReprepare != 0 {
		...
		if rc != SQLITE_OK {
			fatal_error(tls, __ccgo_ts+562, libc.VaList(bp+48, libsqlite3.Xsqlite3_sql(tls, **(**uintptr)(__ccgo_up(bp + 32))), rc, libsqlite3.Xsqlite3_errmsg(tls, g.Fdb)))
		}
		g.FpStmt = **(**uintptr)(__ccgo_up(bp + 32))
	} else {
			...
			if libc.Xstrcmp(tls, z, __ccgo_ts+36561) == 0 {
				...
				if libc.Xstrcmp(tls, z, __ccgo_ts+36572) == 0 {
					...
					if libc.Xstrcmp(tls, z, __ccgo_ts+36589) == 0 {
						...
						i = i + 1
						v4 = i
						cacheSize = integerValue(tls, **(**uintptr)(__ccgo_up(argv + uintptr(v4)*8)))
					} else {
											...
											if libc.Xstrcmp(tls, z, __ccgo_ts+36678) == 0 {
												...
												if libc.Xstrcmp(tls, z, __ccgo_ts+36683) == 0 {
													...
													if libc.Xstrcmp(tls, z, __ccgo_ts+36694) == 0 {
														...
														i = i + 1
														v4 = i
														zJMode = **(**uintptr)(__ccgo_up(argv + uintptr(v4)*8))
													} else {
														if libc.Xstrcmp(tls, z, __ccgo_ts+36702) == 0 {
															...
															i = i + 1
															v4 = i
															zKey = **(**uintptr)(__ccgo_up(argv + uintptr(v4)*8))
														} else {
																	...
																	if libc.Xstrcmp(tls, z, __ccgo_ts+36722) == 0 {
																		...
																		if libc.Xstrcmp(tls, z, __ccgo_ts+36734) == 0 {
																			...
																			if libc.Xstrcmp(tls, z, __ccgo_ts+36744) == 0 {
																				...
																				i = i + 1
																				v4 = i
																				mmapSize = integerValue(tls, **(**uintptr)(__ccgo_up(argv + uintptr(v4)*8)))
																			} else {
																						...
																						if libc.Xstrcmp(tls, z, __ccgo_ts+36764) == 0 {
																							...
																							if libc.Xstrcmp(tls, z, __ccgo_ts+36781) == 0 {
																								...
																								if libc.Xstrcmp(tls, z, __ccgo_ts+36823) == 0 {
																									...
																									i = i + 1
																									v4 = i
																									pageSize = integerValue(tls, **(**uintptr)(__ccgo_up(argv + uintptr(v4)*8)))
																								} else {
																									if libc.Xstrcmp(tls, z, __ccgo_ts+36832) == 0 {
																										...
																										if libc.Xstrcmp(tls, z, __ccgo_ts+36839) == 0 {
																											...
																											if libc.Xstrcmp(tls, z, __ccgo_ts+36862) == 0 {
																												...
																												i = i + 1
																												v4 = i
																												g.FnRepeat = integerValue(tls, **(**uintptr)(__ccgo_up(argv + uintptr(v4)*8)))
																											} else {
																																...
																																if libc.Xstrcmp(tls, z, __ccgo_ts+36943) == 0 {
																																	...
																																	if libc.Xstrcmp(tls, z, __ccgo_ts+36951) == 0 {
																																		...
																																		if libc.Xstrcmp(tls, z, __ccgo_ts+36965) == 0 {
																																			...
																																			i = i + 1
																																			v5 = i
																																			v4 = integerValue(tls, **(**uintptr)(__ccgo_up(argv + uintptr(v5)*8)))
																																			g.FszBase = v4
																																			g.FszTest = v4
																																		} else {
																																				...
																																				if libc.Xstrcmp(tls, z, __ccgo_ts+36986) == 0 {
																																					...
																																					if libc.Xstrcmp(tls, z, __ccgo_ts+36992) == 0 {
																																						...
																																						if libc.Xstrcmp(tls, z, __ccgo_ts+37050) == 0 {
																																							...
																																							i = i + 1
																																							v4 = i
																																							zTSet = **(**uintptr)(__ccgo_up(argv + uintptr(v4)*8))
																																						} else {
																																							if libc.Xstrcmp(tls, z, __ccgo_ts+37058) == 0 {
																																								...
																																								if libc.Xstrcmp(tls, z, __ccgo_ts+37064) == 0 {
																																									...
																																									i = i + 1
																																									v4 = i
																																									nThread = integerValue(tls, **(**uintptr)(__ccgo_up(argv + uintptr(v4)*8)))
																																								} else {
																																										...
																																										if libc.Xstrcmp(tls, z, __ccgo_ts+37080) == 0 {
																																											...
																																											if libc.Xstrcmp(tls, z, __ccgo_ts+37088) == 0 {
																																												...
																																												if libc.Xstrcmp(tls, z, __ccgo_ts+37095) == 0 {
																																													...
																																													i = i + 1
																																													v4 = i
																																													g.FzVfs = **(**uintptr)(__ccgo_up(argv + uintptr(v4)*8))
																																												} else {
																																													if libc.Xstrcmp(tls, z, __ccgo_ts+37099) == 0 {
																																														...
																																														i = i + 1
																																														v4 = i
																																														g.FnReserve = libc.Xatoi(tls, **(**uintptr)(__ccgo_up(argv + uintptr(v4)*8)))
																																													} else {
