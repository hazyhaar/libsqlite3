// Code generated for linux/ppc64le by 'generator -DNDEBUG -DSQLITE_DISABLE_INTRINSIC -DSQLITE_ENABLE_DBPAGE_VTAB -DSQLITE_ENABLE_RTREE -ignore-unsupported-alignment -ignore-link-errors -o speedtest1/ccgo_linux_ppc64le.go -I /tmp/libsqlite3/sqlite-src-3530200 /tmp/libsqlite3/sqlite-src-3530200/test/speedtest1.c -lsqlite3', DO NOT EDIT.
	...
	for {
		...
		if libc.Int32FromUint8(**(**uint8)(__ccgo_up(z))) == int32('-') {
			...
			if libc.Xstrcmp(tls, z, __ccgo_ts+36834) == 0 {
				...
				if libc.Xstrcmp(tls, z, __ccgo_ts+36845) == 0 {
					...
					if libc.Xstrcmp(tls, z, __ccgo_ts+36862) == 0 {
						if i >= argc-int32(1) {
							fatal_error(tls, __ccgo_ts+36872, libc.VaList(bp+16, **(**uintptr)(__ccgo_up(argv + uintptr(i)*8))))
						}
						i = i + 1
						v2 = i
																					...
																					if libc.Xstrcmp(tls, z, __ccgo_ts+37030) == 0 {
																						...
																						if libc.Xstrcmp(tls, z, __ccgo_ts+37037) == 0 {
																							...
																							if libc.Xstrcmp(tls, z, __ccgo_ts+37054) == 0 {
																								...
																								i = i + 1
																								if libc.Xstrcmp(tls, **(**uintptr)(__ccgo_up(argv + uintptr(i)*8)), __ccgo_ts+37061) == 0 {
																									g.FhashFile = libc.Xstdout
																								} else {
																									g.FhashFile = libc.Xfopen(tls, **(**uintptr)(__ccgo_up(argv + uintptr(i)*8)), __ccgo_ts+37063)
																									if g.FhashFile == uintptr(0) {
																										fatal_error(tls, __ccgo_ts+37066, libc.VaList(bp+16, **(**uintptr)(__ccgo_up(argv + uintptr(i)*8))))
																									}
																								}
																							} else {
																													...
																													if libc.Xstrcmp(tls, z, __ccgo_ts+37152) == 0 {
																														...
																														if libc.Xstrcmp(tls, z, __ccgo_ts+37163) == 0 {
																															...
																															if libc.Xstrcmp(tls, z, __ccgo_ts+37176) == 0 {
																																...
																																i = i + 1
																																v2 = i
																																g.FpScript = libc.Xfopen(tls, **(**uintptr)(__ccgo_up(argv + uintptr(v2)*8)), __ccgo_ts+37063)
																																if g.FpScript == uintptr(0) {
																																	fatal_error(tls, __ccgo_ts+37183, libc.VaList(bp+16, **(**uintptr)(__ccgo_up(argv + uintptr(i)*8))))
																																}
																															} else {
																																															...
																																															if libc.Xstrcmp(tls, z, __ccgo_ts+37395) == 0 {
																																																...
																																																if libc.Xstrcmp(tls, z, __ccgo_ts+37445) == 0 {
																																																	...
																																																	if libc.Xstrcmp(tls, z, __ccgo_ts+37452) == 0 || libc.Xstrcmp(tls, z, __ccgo_ts+37457) == 0 {
																																																		...
																																																		fatal_error(tls, __ccgo_ts+37459, libc.VaList(bp+16, **(**uintptr)(__ccgo_up(argv + uintptr(i)*8)), **(**uintptr)(__ccgo_up(argv))))
																																																	}
																																																}
																																															}
																																														}
			...
			if g.FzDbName == uintptr(0) {
				...
				fatal_error(tls, __ccgo_ts+37500, libc.VaList(bp+16, **(**uintptr)(__ccgo_up(argv + uintptr(i)*8)), **(**uintptr)(__ccgo_up(argv))))
			}
		}
		goto _1
	_1:
