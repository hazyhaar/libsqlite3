// Code generated for freebsd/386 by 'generator -DNDEBUG -DSQLITE_DISABLE_INTRINSIC -DSQLITE_ENABLE_DBPAGE_VTAB -DSQLITE_ENABLE_RTREE -ignore-unsupported-alignment -ignore-link-errors -o speedtest1/ccgo_freebsd_386.go -I /tmp/libsqlite3/sqlite-src-3530100 /tmp/libsqlite3/sqlite-src-3530100/test/speedtest1.c -lsqlite3', DO NOT EDIT.
...
func HashInit(tls *libc.TLS) {
	...
	for {
		...
		**(**uint8)(__ccgo_up(uintptr(unsafe.Pointer(&g)) + 3128 + 3 + uintptr(k))) = uint8(k)
		goto _1
	_1:
		;
		k = k + 1
...
func HashUpdate(tls *libc.TLS, aData uintptr, nData uint32) {
	...
	for {
		...
		j = libc.Uint8FromInt32(int32(j) + (libc.Int32FromUint8(**(**uint8)(__ccgo_up(uintptr(unsafe.Pointer(&g)) + 3128 + 3 + uintptr(i)))) + libc.Int32FromUint8(**(**uint8)(__ccgo_up(aData + uintptr(k))))))
		t = **(**uint8)(__ccgo_up(uintptr(unsafe.Pointer(&g)) + 3128 + 3 + uintptr(j)))
		**(**uint8)(__ccgo_up(uintptr(unsafe.Pointer(&g)) + 3128 + 3 + uintptr(j))) = **(**uint8)(__ccgo_up(uintptr(unsafe.Pointer(&g)) + 3128 + 3 + uintptr(i)))
		**(**uint8)(__ccgo_up(uintptr(unsafe.Pointer(&g)) + 3128 + 3 + uintptr(i))) = t
		i = i + 1
		goto _1
	_1:
		;
...
func HashFinal(tls *libc.TLS) {
	...
	for {
		...
		i = i + 1
		t = **(**uint8)(__ccgo_up(uintptr(unsafe.Pointer(&g)) + 3128 + 3 + uintptr(i)))
		j = libc.Uint8FromInt32(int32(j) + libc.Int32FromUint8(t))
		**(**uint8)(__ccgo_up(uintptr(unsafe.Pointer(&g)) + 3128 + 3 + uintptr(i))) = **(**uint8)(__ccgo_up(uintptr(unsafe.Pointer(&g)) + 3128 + 3 + uintptr(j)))
		**(**uint8)(__ccgo_up(uintptr(unsafe.Pointer(&g)) + 3128 + 3 + uintptr(j))) = t
		t = libc.Uint8FromInt32(int32(t) + libc.Int32FromUint8(**(**uint8)(__ccgo_up(uintptr(unsafe.Pointer(&g)) + 3128 + 3 + uintptr(i)))))
		**(**uint8)(__ccgo_up(uintptr(unsafe.Pointer(&g)) + 3128 + 259 + uintptr(k))) = **(**uint8)(__ccgo_up(uintptr(unsafe.Pointer(&g)) + 3128 + 3 + uintptr(t)))
		goto _1
	_1:
		;
		k = k + 1
...
func integerValue(tls *libc.TLS, zArg uintptr) (r int32) {
	...
	if int32(**(**int8)(__ccgo_up(zArg))) == int32('0') && int32(**(**int8)(__ccgo_up(zArg + 1))) == int32('x') {
		zArg = zArg + uintptr(2)
		for {
			v1 = hexDigitValue(tls, **(**int8)(__ccgo_up(zArg)))
			x = v1
			if !(v1 >= 0) {
				break
			}
		...
		_3:
			...
			v = v*int64(10) + int64(**(**int8)(__ccgo_up(zArg))) - int64('0')
			zArg = zArg + 1
		}
	}
	i = 0
...
func speedtest1_final(tls *libc.TLS) {
	...
	if g.FbVerify != 0 {
		...
		for {
			...
			libc.Xprintf(tls, __ccgo_ts+459, libc.VaList(bp+8, libc.Int32FromUint8(**(**uint8)(__ccgo_up(uintptr(unsafe.Pointer(&g)) + 3128 + 259 + uintptr(i))))))
			goto _1
		_1:
			;
			i = i + 1
...
func printSql(tls *libc.TLS, zSql uintptr) {
	...
	for {
		if v10 = n > 0; v10 {
			if v9 = int32(**(**int8)(__ccgo_up(zSql + uintptr(n-int32(1))))) == int32(';'); !v9 {
				v3 = libc.Int32FromUint8(libc.Uint8FromInt8(**(**int8)(__ccgo_up(zSql + uintptr(n-int32(1))))))
	...
	for libsqlite3.Xsqlite3_step(tls, g.FpStmt) == int32(SQLITE_ROW) {
		...
		for {
			...
			if g.FbVerify != 0 {
				...
				(**(**[2]uint8)(__ccgo_up(bp)))[int32(1)] = libc.Uint8FromInt8(**(**int8)(__ccgo_up(__ccgo_ts + 588 + uintptr(eType))))
				if g.FnResByte != 0 {
				...
				if eType == int32(SQLITE_FLOAT) {
					...
					if eType == int32(SQLITE_BLOB) {
						...
						for {
							...
							(**(**[2]uint8)(__ccgo_up(bp + 2)))[0] = libc.Uint8FromInt8(**(**int8)(__ccgo_up(__ccgo_ts + 595 + uintptr(libc.Int32FromUint8(**(**uint8)(__ccgo_up(aBlob + uintptr(iBlob))))>>int32(4)))))
							(**(**[2]uint8)(__ccgo_up(bp + 2)))[int32(1)] = libc.Uint8FromInt8(**(**int8)(__ccgo_up(__ccgo_ts + 595 + uintptr(libc.Int32FromUint8(**(**uint8)(__ccgo_up(aBlob + uintptr(iBlob))))&int32(15)))))
			...
			if libc.Uint32FromInt32(g.FnResult+len1) < libc.Uint32FromInt64(3000)-libc.Uint32FromInt32(2) {
				if g.FnResult > 0 {
					...
					**(**int8)(__ccgo_up(uintptr(unsafe.Pointer(&g)) + 120 + uintptr(v3))) = int8(' ')
				}
...
func testset_main(tls *libc.TLS) {
	...
	for {
		...
		if (i-int32(1))%g.FnRepeat == 0 {
			...
			(**(**[2000]int8)(__ccgo_up(bp)))[len1] = int8('%')
			(**(**[2000]int8)(__ccgo_up(bp)))[len1+int32(1)] = 0
		}
...
func testset_app(tls *libc.TLS) {
	...
	for {
		...
		dbMain = g.Fdb
		**(**uintptr)(__ccgo_up(bp)) = uintptr(0)
		if g.FzDbName != 0 && **(**int8)(__ccgo_up(g.FzDbName)) != 0 {
...
func testset_rtree(tls *libc.TLS, p1 int32, p2 int32) {
	...
	for {
		...
		speedtest1_run(tls)
		**(**int32)(__ccgo_up(aCheck + uintptr(i)*4)) = libc.Xatoi(tls, uintptr(unsafe.Pointer(&g))+120)
		goto _3
	_3:
		;
		i = i + 1
	...
	if g.FbVerify != 0 {
		...
		for {
			...
			libsqlite3.Xsqlite3_bind_int(tls, g.FpStmt, int32(2), libc.Int32FromUint32((i+uint32(1))*iStep))
			speedtest1_run(tls)
			if **(**int32)(__ccgo_up(aCheck + uintptr(i)*4)) != libc.Xatoi(tls, uintptr(unsafe.Pointer(&g))+120) {
				fatal_error(tls, __ccgo_ts+20845, libc.VaList(bp+32, i, i*iStep, (i+uint32(1))*iStep, **(**int32)(__ccgo_up(aCheck + uintptr(i)*4)), libc.Xatoi(tls, uintptr(unsafe.Pointer(&g))+120)))
			}
			goto _4
		_4:
			;
...
func main1(tls *libc.TLS, argc int32, argv uintptr) (r int32) {
	...
	for {
		...
		if int32(**(**int8)(__ccgo_up(z))) == int32('-') {
			for cond := true; cond; cond = int32(**(**int8)(__ccgo_up(z))) == int32('-') {
				z = z + 1
			}
																																			...
																																			if libc.Xstrcmp(tls, z, __ccgo_ts+36970) == 0 {
																																				...
																																				if libc.Xstrcmp(tls, z, __ccgo_ts+36986) == 0 {
																																					...
																																					if libc.Xstrcmp(tls, z, __ccgo_ts+36992) == 0 {
																																						...
																																						i = i + 1
																																						if int32(**(**int8)(__ccgo_up(**(**uintptr)(__ccgo_up(argv + uintptr(i)*4))))) < int32('0') || int32(**(**int8)(__ccgo_up(**(**uintptr)(__ccgo_up(argv + uintptr(i)*4))))) > int32('9') || int32(**(**int8)(__ccgo_up(**(**uintptr)(__ccgo_up(argv + uintptr(i)*4)) + 1))) != 0 {
																																							fatal_error(tls, __ccgo_ts+36997, 0)
																																						}
																																						g.FeTemp = int32(**(**int8)(__ccgo_up(**(**uintptr)(__ccgo_up(argv + uintptr(i)*4))))) - int32('0')
																																					} else {
	...
	for cond := true; cond; cond = **(**int8)(__ccgo_up(zTSet)) != 0 {
		zThisTest = zTSet
		zComma = libc.Xstrchr(tls, zThisTest, int32(','))
		if zComma != 0 {
			**(**int8)(__ccgo_up(zComma)) = 0
		...
		if zSep != 0 {
			kk = int32(1)
			for {
				if v25 = **(**int8)(__ccgo_up(zSep + uintptr(kk))) != 0; v25 {
					v19 = libc.Int32FromUint8(libc.Uint8FromInt8(**(**int8)(__ccgo_up(zSep + uintptr(kk)))))
