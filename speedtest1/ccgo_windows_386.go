...
func speedtest1_final(tls *libc.TLS) {
	...
	_4:
		...
		for {
			...
			v1 = __ccgo_ts + 459
			libc.VaList(bp+80, int32(**(**uint8)(__ccgo_up(uintptr(unsafe.Pointer(&g)) + 3132 + 259 + uintptr(i)))))
			__local_argv = bp + 80
			__retval = libc.X__mingw_vfprintf(tls, libc.X__acrt_iob_func(tls, uint32(1)), v1, __local_argv)
			_ = __local_argv
			_ = __retval
	...
	for {
		...
		if int32(**(**int8)(__ccgo_up(z))) == int32('-') {
			...
			if libc.Xstrcmp(tls, z, __ccgo_ts+36561) == 0 {
				...
				if libc.Xstrcmp(tls, z, __ccgo_ts+36572) == 0 {
					...
					if libc.Xstrcmp(tls, z, __ccgo_ts+36589) == 0 {
						if i >= argc-int32(1) {
							fatal_error(tls, __ccgo_ts+36599, libc.VaList(bp+600, **(**uintptr)(__ccgo_up(argv + uintptr(i)*4))))
						}
						i = i + 1
						v4 = i
																							...
																							if libc.Xstrcmp(tls, z, __ccgo_ts+36781) == 0 {
																								...
																								if libc.Xstrcmp(tls, **(**uintptr)(__ccgo_up(argv + uintptr(i)*4)), __ccgo_ts+36788) == 0 {
																									...
																									if g.FhashFile == uintptr(0) {
																										fatal_error(tls, __ccgo_ts+36793, libc.VaList(bp+600, **(**uintptr)(__ccgo_up(argv + uintptr(i)*4))))
																									}
																								}
																							} else {
																														...
																														if libc.Xstrcmp(tls, z, __ccgo_ts+36890) == 0 {
																															...
																															if libc.Xstrcmp(tls, z, __ccgo_ts+36903) == 0 {
																																...
																																if g.FpScript == uintptr(0) {
																																	fatal_error(tls, __ccgo_ts+36910, libc.VaList(bp+600, **(**uintptr)(__ccgo_up(argv + uintptr(i)*4))))
																																}
																															} else {
																																															...
																																															if libc.Xstrcmp(tls, z, __ccgo_ts+37122) == 0 {
																																																...
																																																if libc.Xstrcmp(tls, z, __ccgo_ts+37172) == 0 {
																																																	...
																																																	_18:
																																																		...
																																																		fatal_error(tls, __ccgo_ts+37186, libc.VaList(bp+600, **(**uintptr)(__ccgo_up(argv + uintptr(i)*4)), **(**uintptr)(__ccgo_up(argv))))
																																																	}
																																																}
																																															}
																																														}
			...
			if g.FzDbName == uintptr(0) {
				...
				fatal_error(tls, __ccgo_ts+37227, libc.VaList(bp+600, **(**uintptr)(__ccgo_up(argv + uintptr(i)*4)), **(**uintptr)(__ccgo_up(argv))))
			}
		}
		goto _3
	_3:
