// Code generated for freebsd/arm64 by 'generator -DNDEBUG -DSQLITE_DISABLE_INTRINSIC -DSQLITE_ENABLE_DBPAGE_VTAB -DSQLITE_ENABLE_RTREE -ignore-unsupported-alignment -ignore-link-errors -o speedtest1/ccgo_freebsd_arm64.go -I /tmp/libsqlite3/sqlite-src-3530100 /tmp/libsqlite3/sqlite-src-3530100/test/speedtest1.c -lsqlite3', DO NOT EDIT.
	...
	if libc.Int32FromUint8(**(**uint8)(__ccgo_up(zArg))) == int32('0') && libc.Int32FromUint8(**(**uint8)(__ccgo_up(zArg + 1))) == int32('x') {
		...
		for {
			...
			if v4 < 0 || v4 >= libc.X__mb_sb_limit {
				...
				goto _9
			_9:
				v7 = **(**uint64)(__ccgo_up(v8 + 64 + uintptr(v4)*8)) & uint64(0x00000400)
			}
...
func speedtest1_timestamp(tls *libc.TLS) (r sqlite3_int64) {
	...
	if (*sqlite3_vfs)(unsafe.Pointer(clockVfs)).FiVersion >= int32(2) && (*sqlite3_vfs)(unsafe.Pointer(clockVfs)).FxCurrentTimeInt64 != uintptr(0) {
		...
		**(**sqlite3_int64)(__ccgo_up(bp)) = int64(**(**float64)(__ccgo_up(bp + 8)) * libc.Float64FromFloat64(8.64e+07))
	}
			...
			for {
				if v25 = **(**uint8)(__ccgo_up(zSep + uintptr(kk))) != 0; v25 {
					...
					if v19 < 0 || v19 >= libc.X__mb_sb_limit {
						...
						goto _24
					_24:
						v22 = **(**uint64)(__ccgo_up(v15 + 64 + uintptr(v19)*8)) & uint64(0x00000400)
					}
