// Code generated for linux/386 by 'generator -DNDEBUG -DSQLITE_DISABLE_INTRINSIC -DSQLITE_ENABLE_DBPAGE_VTAB -DSQLITE_ENABLE_RTREE -ignore-unsupported-alignment -ignore-link-errors -o speedtest1/ccgo_linux_386.go -I /tmp/libsqlite3/sqlite-src-3530200 /tmp/libsqlite3/sqlite-src-3530200/test/speedtest1.c -lsqlite3', DO NOT EDIT.
...
func integerValue(tls *libc.TLS, zArg uintptr) (r int32) {
	...
	if int32(**(**int8)(__ccgo_up(zArg))) == int32('0') && int32(**(**int8)(__ccgo_up(zArg + 1))) == int32('x') {
		...
		for libc.BoolInt32(libc.Uint32FromInt8(**(**int8)(__ccgo_up(zArg)))-uint32('0') < uint32(10)) != 0 {
...
func printSql(tls *libc.TLS, zSql uintptr) {
	...
	for {
		if v5 = n > 0; v5 {
			if v4 = int32(**(**int8)(__ccgo_up(zSql + uintptr(n-int32(1))))) == int32(';'); !v4 {
				v1 = libc.Int32FromUint8(libc.Uint8FromInt8(**(**int8)(__ccgo_up(zSql + uintptr(n-int32(1))))))
...
func main1(tls *libc.TLS, argc int32, argv uintptr) (r int32) {
	...
	for cond := true; cond; cond = **(**int8)(__ccgo_up(zTSet)) != 0 {
		...
		if zSep != 0 {
			kk = int32(1)
			for {
				if !(**(**int8)(__ccgo_up(zSep + uintptr(kk))) != 0 && libc.BoolInt32(uint32(libc.Uint8FromInt8(**(**int8)(__ccgo_up(zSep + uintptr(kk)))))-uint32('0') < uint32(10)) != 0) {
					break
				}
				goto _16
			_16:
