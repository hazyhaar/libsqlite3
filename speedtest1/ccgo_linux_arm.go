// Code generated for linux/arm by 'generator -DNDEBUG -DSQLITE_DISABLE_INTRINSIC -DSQLITE_ENABLE_DBPAGE_VTAB -DSQLITE_ENABLE_RTREE -ignore-unsupported-alignment -ignore-link-errors -o speedtest1/ccgo_linux_arm.go -I /tmp/libsqlite3/sqlite-src-3530100 /tmp/libsqlite3/sqlite-src-3530100/test/speedtest1.c -lsqlite3', DO NOT EDIT.
...
func integerValue(tls *libc.TLS, zArg uintptr) (r int32) {
	...
	if libc.Int32FromUint8(**(**uint8)(__ccgo_up(zArg))) == int32('0') && libc.Int32FromUint8(**(**uint8)(__ccgo_up(zArg + 1))) == int32('x') {
		...
		for libc.BoolInt32(uint32(**(**uint8)(__ccgo_up(zArg)))-uint32('0') < uint32(10)) != 0 {
...
func printSql(tls *libc.TLS, zSql uintptr) {
	...
	for {
		if v5 = n > 0; v5 {
			if v4 = libc.Int32FromUint8(**(**uint8)(__ccgo_up(zSql + uintptr(n-int32(1))))) == int32(';'); !v4 {
				v1 = libc.Int32FromUint8(uint8(**(**uint8)(__ccgo_up(zSql + uintptr(n-int32(1))))))
...
func xCompileOptions(tls *libc.TLS, pCtx uintptr, nVal int32, azVal uintptr, azCol uintptr) (r int32) {
	bp := tls.Alloc(16)
	defer tls.Free(16)
	libc.Xprintf(tls, __ccgo_ts+36764, libc.VaList(bp+8, **(**uintptr)(__ccgo_up(azVal))))
	return SQLITE_OK
}
...
func main1(tls *libc.TLS, argc int32, argv uintptr) (r int32) {
	...
	for {
		...
		if libc.Int32FromUint8(**(**uint8)(__ccgo_up(z))) == int32('-') {
			...
			if libc.Xstrcmp(tls, z, __ccgo_ts+36834) == 0 {
				...
				if libc.Xstrcmp(tls, z, __ccgo_ts+36845) == 0 {
					...
					if libc.Xstrcmp(tls, z, __ccgo_ts+36862) == 0 {
						if i >= argc-int32(1) {
							fatal_error(tls, __ccgo_ts+36872, libc.VaList(bp+16, **(**uintptr)(__ccgo_up(argv + uintptr(i)*4))))
						}
						i = i + 1
						v2 = i
																					...
																					if libc.Xstrcmp(tls, z, __ccgo_ts+37030) == 0 {
																						...
																						if libc.Xstrcmp(tls, z, __ccgo_ts+37037) == 0 {
																							...
																							if libc.Xstrcmp(tls, z, __ccgo_ts+37054) == 0 {
																								...
																								i = i + 1
																								if libc.Xstrcmp(tls, **(**uintptr)(__ccgo_up(argv + uintptr(i)*4)), __ccgo_ts+37061) == 0 {
																									g.FhashFile = libc.Xstdout
																								} else {
																									g.FhashFile = libc.Xfopen(tls, **(**uintptr)(__ccgo_up(argv + uintptr(i)*4)), __ccgo_ts+37063)
																									if g.FhashFile == uintptr(0) {
																										fatal_error(tls, __ccgo_ts+37066, libc.VaList(bp+16, **(**uintptr)(__ccgo_up(argv + uintptr(i)*4))))
																									}
																								}
																							} else {
																													...
																													if libc.Xstrcmp(tls, z, __ccgo_ts+37152) == 0 {
																														...
																														if libc.Xstrcmp(tls, z, __ccgo_ts+37163) == 0 {
																															...
																															if libc.Xstrcmp(tls, z, __ccgo_ts+37176) == 0 {
																																...
																																i = i + 1
																																v2 = i
																																g.FpScript = libc.Xfopen(tls, **(**uintptr)(__ccgo_up(argv + uintptr(v2)*4)), __ccgo_ts+37063)
																																if g.FpScript == uintptr(0) {
																																	fatal_error(tls, __ccgo_ts+37183, libc.VaList(bp+16, **(**uintptr)(__ccgo_up(argv + uintptr(i)*4))))
																																}
																															} else {
																																															...
																																															if libc.Xstrcmp(tls, z, __ccgo_ts+37395) == 0 {
																																																...
																																																if libc.Xstrcmp(tls, z, __ccgo_ts+37445) == 0 {
																																																	...
																																																	if libc.Xstrcmp(tls, z, __ccgo_ts+37452) == 0 || libc.Xstrcmp(tls, z, __ccgo_ts+37457) == 0 {
																																																		...
																																																		fatal_error(tls, __ccgo_ts+37459, libc.VaList(bp+16, **(**uintptr)(__ccgo_up(argv + uintptr(i)*4)), **(**uintptr)(__ccgo_up(argv))))
																																																	}
																																																}
																																															}
																																														}
			...
			if g.FzDbName == uintptr(0) {
				...
				fatal_error(tls, __ccgo_ts+37500, libc.VaList(bp+16, **(**uintptr)(__ccgo_up(argv + uintptr(i)*4)), **(**uintptr)(__ccgo_up(argv))))
			}
		}
		goto _1
	_1:
	...
	for cond := true; cond; cond = **(**uint8)(__ccgo_up(zTSet)) != 0 {
		...
		if zSep != 0 {
			kk = int32(1)
			for {
				if !(**(**uint8)(__ccgo_up(zSep + uintptr(kk))) != 0 && libc.BoolInt32(uint32(uint8(**(**uint8)(__ccgo_up(zSep + uintptr(kk)))))-uint32('0') < uint32(10)) != 0) {
					break
				}
				goto _16
			_16:
	...
	if showStats != 0 {
		...
		libc.Xprintf(tls, __ccgo_ts+38869, libc.VaList(bp+16, **(**int32)(__ccgo_up(bp)), **(**int32)(__ccgo_up(bp + 4))))
		libsqlite3.Xsqlite3_status(tls, int32(SQLITE_STATUS_MALLOC_COUNT), bp, bp+4, 0)
		libc.Xprintf(tls, __ccgo_ts+38914, libc.VaList(bp+16, **(**int32)(__ccgo_up(bp)), **(**int32)(__ccgo_up(bp + 4))))
		libsqlite3.Xsqlite3_status(tls, int32(SQLITE_STATUS_PAGECACHE_OVERFLOW), bp, bp+4, 0)
		libc.Xprintf(tls, __ccgo_ts+38959, libc.VaList(bp+16, **(**int32)(__ccgo_up(bp)), **(**int32)(__ccgo_up(bp + 4))))
		libsqlite3.Xsqlite3_status(tls, int32(SQLITE_STATUS_MALLOC_SIZE), bp, bp+4, 0)
		libc.Xprintf(tls, __ccgo_ts+39004, libc.VaList(bp+16, **(**int32)(__ccgo_up(bp + 4))))
		libsqlite3.Xsqlite3_status(tls, int32(SQLITE_STATUS_PAGECACHE_SIZE), bp, bp+4, 0)
		libc.Xprintf(tls, __ccgo_ts+39046, libc.VaList(bp+16, **(**int32)(__ccgo_up(bp + 4))))
	}
	if showStats != 0 {
