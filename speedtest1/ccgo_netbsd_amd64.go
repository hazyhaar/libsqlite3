// Code generated for netbsd/amd64 by 'generator -DNDEBUG -DSQLITE_DISABLE_INTRINSIC -DSQLITE_ENABLE_DBPAGE_VTAB -DSQLITE_ENABLE_RTREE -ignore-unsupported-alignment -ignore-link-errors -o speedtest1/ccgo_netbsd_amd64.go -I /tmp/libsqlite3/sqlite-src-3530200 /tmp/libsqlite3/sqlite-src-3530200/test/speedtest1.c -lsqlite3', DO NOT EDIT.
...
func integerValue(tls *libc.TLS, zArg uintptr) (r int32) {
	...
	if int32(**(**int8)(__ccgo_up(zArg))) == int32('0') && int32(**(**int8)(__ccgo_up(zArg + 1))) == int32('x') {
		...
		for libc.Int32FromUint16(**(**uint16)(__ccgo_up(libc.X_ctype_tab_ + libc.UintptrFromInt32(1)*2 + uintptr(**(**int8)(__ccgo_up(zArg)))*2)))&libc.Int32FromInt32(_CTYPE_D) != 0 {
...
func speedtest1_final(tls *libc.TLS) {
	...
	if g.FbVerify != 0 {
		...
		if g.FhashFile != 0 && g.FhashFile != uintptr(unsafe.Pointer(&libc.X__sF))+1*152 {
...
func printSql(tls *libc.TLS, zSql uintptr) {
	...
	for n > 0 && (int32(**(**int8)(__ccgo_up(zSql + uintptr(n-int32(1))))) == int32(';') || libc.Int32FromUint16(**(**uint16)(__ccgo_up(libc.X_ctype_tab_ + libc.UintptrFromInt32(1)*2 + uintptr(libc.Uint8FromInt8(**(**int8)(__ccgo_up(zSql + uintptr(n-int32(1))))))*2)))&libc.Int32FromInt32(_CTYPE_S) != 0) {
		n = n - 1
	}
	if g.FbExplain != 0 {
...
func main1(tls *libc.TLS, argc int32, argv uintptr) (r int32) {
																						...
																						if libc.Xstrcmp(tls, z, __ccgo_ts+36764) == 0 {
																							...
																							if libc.Xstrcmp(tls, z, __ccgo_ts+36781) == 0 {
																								...
																								if libc.Xstrcmp(tls, **(**uintptr)(__ccgo_up(argv + uintptr(i)*8)), __ccgo_ts+36788) == 0 {
																									g.FhashFile = uintptr(unsafe.Pointer(&libc.X__sF)) + 1*152
																								} else {
	...
	for cond := true; cond; cond = **(**int8)(__ccgo_up(zTSet)) != 0 {
		...
		if zSep != 0 {
			kk = int32(1)
			for {
				if !(**(**int8)(__ccgo_up(zSep + uintptr(kk))) != 0 && libc.Int32FromUint16(**(**uint16)(__ccgo_up(libc.X_ctype_tab_ + libc.UintptrFromInt32(1)*2 + uintptr(libc.Uint8FromInt8(**(**int8)(__ccgo_up(zSep + uintptr(kk)))))*2)))&libc.Int32FromInt32(_CTYPE_D) != 0) {
					break
				}
				goto _16
			_16:
